"function" != typeof Function.prototype.bind && (Function.prototype.bind = function(e) {
  ...
  var e = Date, t = Date.CultureStrings ? Date.CultureStrings.lang :null, i = {}, n = {
    ...
    buildFromDefault:function(e) {
      ...
      switch (e) {
       ...
       default:
        t = e, n = e.split("_"), i = n.length, i > 1 && "/" !== e.charAt(0) && ("initial" !== (r = n[i - 1].toLowerCase()) && "abbr" !== r || (t = n[0]));
      }
      return t;
    },
    ...
    return n.onload = n.onreadystatechange = function() {
      this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || (r.done(), 
      i.removeChild(n));
    }, setTimeout(function() {
    ...
    return function() {
      ...
      if (this._same) {
        ...
        for (var o = s.length - 1; o > -1; o--) {
          if (n = s[o].toLowerCase(), t[n] !== i[n]) return !1;
          if (r === n) break;
        }
        return !0;
      }
  ...
  }, g = 0; g < s.length; g++) "weekday" !== (n = s[g].toLowerCase()) && (t[n] = t[n + "s"] = p(s[g]), 
  i[n] = i[n + "s"] = m(n + "s"));
  t._ss = p("Second");
  ...
  var i = {
    ...
    addToHash:function(e, t, i) {
      t = t, i = i;
      for (var n = t.length, r = 0; r < n; r++) e[t[r]] = i[r];
      return e;
    },
  ...
  e.processTimeObject = function(n) {
    ...
    parse:function(t) {
      ...
      return r && r.length ? (n = i.buildTimeObjectFromData(r), n.year && (n.year || n.month || n.day || n.week || n.dayOfYear) ? e.processTimeObject(n) :null) :null;
    }
  }, e.Numeric = {
  ...
  for (var e = Date.Parsing, t = e.Operators = {
      ...
      return n = n || t.rtoken(/^\s*/), r = r || null, function(o) {
        for (var s = null, a = null, l = null, u = null, c = [ [], o ], d = !1, h = 0; h < i.length; h++) {
          ...
          if (d || 0 !== l[1].length || (d = !0), !d) {
            ...
            a = t.set(f, n).call(this, l[1]), a[0].length > 0 && (u[0] = u[0].concat(a[0]), 
            u[1] = a[1]);
          }
    ...
    function t() {
      ...
      n ? (t = n.shift(), t.length > 0 ? (n.unshift(t[i]), r.push(e.apply(null, n)), n.shift(), 
  ...
  var e = Date, i = e.prototype, n = function(e, t) {
    ...
    interpreted:function(i, r) {
      ...
      switch (i) {
       ...
       case "P":
        return o = r.getUTCOffset(), o.substring(0, o.length - 2) + ":" + o.substring(o.length - 2);
  ...
  var s = function(t) {
    return function(i) {
      ...
      n = e.normalizeFormat(i, t), n ? t.toString(n, r) :void 0);
    };
  };
  ...
  var e = function(e) {
    ...
    return this.getTotalMilliseconds = function() {
      ...
      return new r(this.getTotalMilliseconds() + 864e5 * e);
    }, this.addHours = function(e) {
      return new r(this.getTotalMilliseconds() + 36e5 * e);
    }, this.addMinutes = function(e) {
      return new r(this.getTotalMilliseconds() + 6e4 * e);
    }, this.addSeconds = function(e) {
      return new r(this.getTotalMilliseconds() + 1e3 * e);
    }, this.addMilliseconds = function(e) {
      return new r(this.getTotalMilliseconds() + e);
  ...
  n(r, i.slice(2)), r.prototype.set = function(e, t, i, n, r) {
    ...
    return new r(0, this.getHours(), this.getMinutes(), this.getSeconds(), this.getMilliseconds());
  }, Date.TimeSpan = r, "undefined" != typeof window && (window.TimeSpan = r);
}(), function() {
  "use strict";
  var e = [ "years", "months", "days", "hours", "minutes", "seconds", "milliseconds" ], t = function(e) {
    ...
    for (var r = 0; r < n.length; r++) {
      var o = n[r], s = o.slice(0, 1).toUpperCase() + o.slice(1);
      e.prototype[o] = 0, e.prototype["get" + s] = t(o), e.prototype["set" + s] = i(o);
    }
  }, r = function(e, t, i, n) {
    function r() {
  ...
  }, s = function(e, t, i, n, s, a, l) {
    if (7 === arguments.length) this.set(e, t, i, n, s, a, l); else if (2 === arguments.length && arguments[0] instanceof Date && arguments[1] instanceof Date) {
      var u = arguments[0].clone(), c = arguments[1].clone(), d = u > c ? 1 :-1;
      this.dates = {
        start:arguments[0].clone(),
        end:arguments[1].clone()
      }, r(d, u, c, this), o(d, u, c);
      var h = c - u;
      if (0 !== h) {
  ...
  n(s, e), s.prototype.set = function(e, t, i, n, r, o, s) {
  ...
  }, Date.TimePeriod = s, "undefined" != typeof window && (window.TimePeriod = s);
}(), function(e, t, i) {
  function n(i) {
    var n = t.console;
  ...
  r(e, "attrFn", s || {}, "jQuery.attrFn is deprecated"), e.attr = function(t, r, o, l) {
    ...
    !e.attrHooks[u] && h.test(u) && (e.attrHooks[u] = {
      ...
      set:function(t, i, n) {
        var r;
        return !1 === i ? e.removeAttr(t, n) :(r = e.propFix[n] || n, r in t && (t[r] = !0), 
  ...
  var p, m, g = e.fn.init, v = e.find, y = e.parseJSON, b = /^\s*</, x = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/, w = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, _ = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
  e.fn.init = function(t, r, o) {
    var s, a;
    return t && "string" == typeof t && !e.isPlainObject(r) && (s = _.exec(e.trim(t))) && s[0] && (b.test(t) || n("$(html) HTML strings must start with '<' character"), 
    ...
    e.parseHTML) ? g.call(this, e.parseHTML(s[2], r && r.ownerDocument || r || document, !0), r, o) :(a = g.apply(this, arguments), 
  ...
  r(e, "browser", e.browser, "jQuery.browser is deprecated"), e.boxModel = e.support.boxModel = "CSS1Compat" === document.compatMode, 
  ...
  e.cleanData = function(t) {
    ...
    e.fn[i] = function(s) {
      ...
      return s = !a && l.length ? e.widget.extend.apply(null, [ s ].concat(l)) :s, a ? this.each(function() {
        ...
        return r ? e.isFunction(r[s]) && "_" !== s.charAt(0) ? (n = r[s].apply(r, l), n !== r && n !== t ? (u = n && n.jquery ? u.pushStack(n.get()) :n, 
  ...
  e.position = {
    scrollbarWidth:function() {
      ...
      return e("body").append(r), i = s.offsetWidth, r.css("overflow", "scroll"), n = s.offsetWidth, 
    ...
    flip:{
      ...
      top:function(e, t) {
        var i, n, r = t.within, o = r.offset.top + r.scrollTop, s = r.height, l = r.isWindow ? r.scrollTop :r.offset.top, u = e.top - t.collisionPosition.marginTop, c = u - l, d = u + t.collisionHeight - s - l, h = "top" === t.my[1], f = h ? -t.elemHeight :"bottom" === t.my[1] ? t.elemHeight :0, p = "top" === t.at[1] ? t.targetHeight :"bottom" === t.at[1] ? -t.targetHeight :0, m = -2 * t.offset[1];
        c < 0 ? (n = e.top + f + p + m + t.collisionHeight - s - o, e.top + f + p + m > c && (n < 0 || n < a(c)) && (e.top += f + p + m)) :d > 0 && (i = e.top - t.collisionPosition.marginTop + f + p + m - l, 
        e.top + f + p + m > d && (i > 0 || a(i) < d) && (e.top += f + p + m));
      }
    },
    flipfit:{
      left:function() {
    ...
    t.appendChild(a), i = s || document.documentElement, i.insertBefore(t, i.firstChild), 
  ...
  e.widget("ui.menu", {
    ...
    _keydown:function(t) {
      ...
      switch (t.keyCode) {
       ...
       default:
        ...
        n.length || (o = String.fromCharCode(t.keyCode), a = new RegExp("^" + i(o), "i"), 
        n = this.activeMenu.children(".ui-menu-item").filter(function() {
          return a.test(e(this).children("a").text());
    ...
    nextPage:function(t) {
      ...
      this.isLastItem() || (this._hasScroll() ? (n = this.active.offset().top, r = this.element.height(), 
    ...
    previousPage:function(t) {
      var i, n, r;
      if (!this.active) return void this.next(t);
      this.isFirstItem() || (this._hasScroll() ? (n = this.active.offset().top, r = this.element.height(), 
  ...
  e.widget("ui.sortable", e.ui.mouse, {
    ...
    _mouseDrag:function(t) {
      ...
      i = this.items.length - 1; i >= 0; i--) if (n = this.items[i], r = n.item[0], (o = this._intersectsWithPointer(n)) && n.instance === this.currentContainer && !(r === this.currentItem[0] || this.placeholder[1 === o ? "next" :"prev"]()[0] === r || e.contains(this.placeholder[0], r) || "semi-dynamic" === this.options.type && e.contains(this.element[0], r))) {
    ...
    _getItemsAsjQuery:function(t) {
      ...
      if (u && t) for (n = u.length - 1; n >= 0; n--) for (o = e(u[n]), r = o.length - 1; r >= 0; r--) (s = e.data(o[r], this.widgetFullName)) && s !== this && !s.options.disabled && l.push([ e.isFunction(s.options.items) ? s.options.items.call(s.element) :e(s.options.items, s.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), s ]);
    ...
    _refreshItems:function(t) {
      ...
      if (h && this.ready) for (i = h.length - 1; i >= 0; i--) for (r = e(h[i]), n = r.length - 1; n >= 0; n--) (o = e.data(r[n], this.widgetFullName)) && o !== this && !o.options.disabled && (d.push([ e.isFunction(o.options.items) ? o.options.items.call(o.element[0], t, {
        item:this.currentItem
      }) :e(o.options.items, o.element), o ]), this.containers.push(o));
      for (i = d.length - 1; i >= 0; i--) for (s = d[i][1], a = d[i][0], n = 0, u = a.length; n < u; n++) l = e(a[n]), 
    ...
    refreshPositions:function(t) {
      ...
      var i, n, r, o;
      for (i = this.items.length - 1; i >= 0; i--) n = this.items[i], n.instance !== this.currentContainer && this.currentContainer && n.item[0] !== this.currentItem[0] || (r = this.options.toleranceElement ? e(this.options.toleranceElement, n.item) :n.item, 
    ...
    _contactContainers:function(n) {
      ...
      this.containers[m].containerCache.over = 1); else {
        for (s = 1e4, a = null, f = p.floating || i(this.currentItem), l = f ? "left" :"top", 
  ...
  e.widget("ui.draggable", e.ui.mouse, {
    ...
    drag:function(t, i) {
      ...
      u = f.snapElements[d].top, c = u + f.snapElements[d].height, v < a - m || g > l + m || b < u - m || y > c + m || !e.contains(f.snapElements[d].item.ownerDocument, f.snapElements[d].item) ? (f.snapElements[d].snapping && f.options.snap.release && f.options.snap.release.call(f.element, t, e.extend(f._uiHash(), {
  ...
  e.rails = i = {
    ...
    blankInputs:function(t, i, n) {
      var r, o, s, a, l = e(), u = i || "input,textarea", c = t.find(u), d = {};
      return c.each(function() {
        r = e(this), r.is("input[type=radio]") ? (a = r.attr("name"), d[a] || (0 === t.find('input[type=radio]:checked[name="' + a + '"]').length && (s = t.find('input[type=radio][name="' + a + '"]'), 
        l = l.add(s)), d[a] = a)) :(o = r.is("input[type=checkbox],input[type=radio]") ? r.is(":checked") :!!r.val()) === n && (l = l.add(r));
      }), !!l.length && l;
    },
  ...
  function e(e) {
    ...
    return function(i, n, r, o) {
      n = b(n, o, 4);
      var s = !T(i) && y.keys(i), a = (s || i).length, l = e > 0 ? 0 :a - 1;
  ...
  function t(e) {
    return function(t, i, n) {
      i = x(i, n);
      for (var r = k(t), o = e > 0 ? 0 :r - 1; o >= 0 && o < r; o += e) if (i(t[o], o, t)) return o;
      return -1;
    };
  }
  function i(e, t, i) {
    return function(n, r, o) {
      var s = 0, a = k(n);
      if ("number" == typeof o) e > 0 ? s = o >= 0 ? o :Math.max(o + a, s) :a = o >= 0 ? Math.min(o + 1, a) :o + a + 1; else if (i && o && a) return o = i(n, r), 
      n[o] === r ? o :-1;
      if (r !== r) return o = t(c.call(n, s, a), y.isNaN), o >= 0 ? o + s :-1;
      for (o = e > 0 ? s :a - 1; o >= 0 && o < a; o += e) if (n[o] === r) return o;
      return -1;
    };
  }
  function n(e, t) {
    var i = I.length, n = e.constructor, r = y.isFunction(n) && n.prototype || a, o = "constructor";
    for (y.has(e, o) && !y.contains(t, o) && t.push(o); i--; ) (o = I[i]) in e && e[o] !== r[o] && !y.contains(t, o) && t.push(o);
  }
  var r = this, o = r._, s = Array.prototype, a = Object.prototype, l = Function.prototype, u = s.push, c = s.slice, d = a.toString, h = a.hasOwnProperty, f = Array.isArray, p = Object.keys, m = l.bind, g = Object.create, v = function() {}, y = function(e) {
  ...
  }, S = Math.pow(2, 53) - 1, k = C("length"), T = function(e) {
    var t = k(e);
  ...
  y.each = y.forEach = function(e, t, i) {
    t = b(t, i);
    var n, r;
    if (T(e)) for (n = 0, r = e.length; n < r; n++) t(e[n], n, e); else {
      var o = y.keys(e);
    ...
    t = x(t, i);
    for (var n = !T(e) && y.keys(e), r = (n || e).length, o = Array(r), s = 0; s < r; s++) {
      var a = n ? n[s] :s;
      o[s] = t(e[a], a, e);
    }
    return o;
    ...
    var n;
    if (void 0 !== (n = T(e) ? y.findIndex(e, t, i) :y.findKey(e, t, i)) && -1 !== n) return e[n];
  }, y.filter = y.select = function(e, t, i) {
    var n = [];
    return t = x(t, i), y.each(e, function(e, i, r) {
      t(e, i, r) && n.push(e);
    }), n;
    ...
    t = x(t, i);
    for (var n = !T(e) && y.keys(e), r = (n || e).length, o = 0; o < r; o++) {
      var s = n ? n[o] :o;
    ...
    return T(e) || (e = y.values(e)), ("number" != typeof i || n) && (i = 0), y.indexOf(e, t, i) >= 0;
  }, y.invoke = function(e, t) {
    var i = c.call(arguments, 2), n = y.isFunction(t);
    ...
    if (null == t && null != e) {
      e = T(e) ? e :y.values(e);
      for (var a = 0, l = e.length; a < l; a++) (n = e[a]) > o && (o = n);
    } else t = x(t, i), y.each(e, function(e, i, n) {
    ...
    for (var t, i = T(e) ? e :y.values(e), n = i.length, r = Array(n), o = 0; o < n; o++) t = y.random(0, o), 
    t !== o && (r[o] = r[t]), r[t] = i[o];
    return r;
  }, y.sample = function(e, t, i) {
    return null == t || i ? (T(e) || (e = y.values(e)), e[y.random(e.length - 1)]) :y.shuffle(e).slice(0, Math.max(0, t));
  }, y.sortBy = function(e, t, i) {
    return t = x(t, i), y.pluck(y.map(e, function(e, i, n) {
      return {
        value:e,
        index:i,
        criteria:t(e, i, n)
  ...
  var M = function(e) {
    return function(t, i, n) {
      var r = {};
      return i = x(i, n), y.each(t, function(n, o) {
        var s = i(n, o, t);
        e(r, n, s);
      }), r;
    };
  ...
  y.groupBy = M(function(e, t, i) {
    ...
    return e ? y.isArray(e) ? c.call(e) :T(e) ? y.map(e, y.identity) :y.values(e) :[];
  }, y.size = function(e) {
    return null == e ? 0 :T(e) ? e.length :y.keys(e).length;
  }, y.partition = function(e, t, i) {
    t = x(t, i);
    var n = [], r = [];
    return y.each(e, function(e, i, o) {
      (t(e, i, o) ? n :r).push(e);
    }), [ n, r ];
  ...
  var D = function(e, t, i, n) {
    for (var r = [], o = 0, s = n || 0, a = k(e); s < a; s++) {
      var l = e[s];
  ...
  y.flatten = function(e, t) {
    ...
    y.isBoolean(t) || (n = i, i = t, t = !1), null != i && (i = x(i, n));
    for (var r = [], o = [], s = 0, a = k(e); s < a; s++) {
      var l = e[s], u = i ? i(l, s, e) :l;
      t ? (s && o === u || r.push(l), o = u) :i ? y.contains(o, u) || (o.push(u), r.push(l)) :y.contains(r, l) || r.push(l);
    }
    return r;
  }, y.union = function() {
    return y.uniq(D(arguments, !0, !0));
  }, y.intersection = function(e) {
    for (var t = [], i = arguments.length, n = 0, r = k(e); n < r; n++) {
      var o = e[n];
      if (!y.contains(t, o)) {
    ...
    for (var t = e && y.max(e, k).length || 0, i = Array(t), n = 0; n < t; n++) i[n] = y.pluck(e, n);
    return i;
  }, y.object = function(e, t) {
    for (var i = {}, n = 0, r = k(e); n < r; n++) t ? i[e[n]] = t[n] :i[e[n][0]] = e[n][1];
    return i;
  }, y.findIndex = t(1), y.findLastIndex = t(-1), y.sortedIndex = function(e, t, i, n) {
    i = x(i, n, 1);
    for (var r = i(t), o = 0, s = k(e); o < s; ) {
  ...
  var A = function(e, t, i, n, r) {
    ...
    var o = _(e.prototype), s = e.apply(o, r);
  ...
  y.bind = function(e, t) {
    ...
    var i = c.call(arguments, 2), n = function() {
      return A(e, n, t, this, i.concat(c.call(arguments)));
    };
    return n;
  }, y.partial = function(e) {
    var t = c.call(arguments, 1), i = function() {
    ...
    i || (i = {});
    var l = function() {
      a = !1 === i.leading ? 0 :y.now(), s = null, o = e.apply(n, r), s || (n = r = null);
    };
    return function() {
      var u = y.now();
      a || !1 !== i.leading || (a = u);
      var c = t - (u - a);
      return n = this, r = arguments, c <= 0 || c > t ? (s && (clearTimeout(s), s = null), 
      a = u, o = e.apply(n, r), s || (n = r = null)) :s || !1 === i.trailing || (s = setTimeout(l, c)), 
      o;
    };
  }, y.debounce = function(e, t, i) {
    var n, r, o, s, a, l = function() {
      var u = y.now() - s;
      u < t && u >= 0 ? n = setTimeout(l, t - u) :(n = null, i || (a = e.apply(o, r), 
      n || (o = r = null)));
    };
    return function() {
      o = this, r = arguments, s = y.now();
      var u = i && !n;
      return n || (n = setTimeout(l, t)), u && (a = e.apply(o, r), o = r = null), a;
    };
  }, y.wrap = function(e, t) {
  ...
  y.keys = function(e) {
    ...
    t = x(t, i);
    for (var n, r = y.keys(e), o = r.length, s = {}, a = 0; a < o; a++) n = r[a], s[n] = t(e[n], n, e);
    return s;
  }, y.pairs = function(e) {
    ...
    var n, r, o = {}, s = e;
    if (null == s) return o;
    y.isFunction(t) ? (r = y.allKeys(s), n = b(t, i)) :(r = D(arguments, !1, !1, 1), 
    n = function(e, t, i) {
      return t in i;
    }, s = Object(s));
    ...
    if (y.isFunction(t)) t = y.negate(t); else {
      var n = y.map(D(arguments, !1, !1, 1), String);
      t = function(e, t) {
  ...
  var j = function(e, t, i, n) {
    ...
    if (i.push(e), n.push(t), o) {
      ...
      for (;l--; ) if (!j(e[l], t[l], i, n)) return !1;
    } else {
      var u, c = y.keys(e);
      if (l = c.length, y.keys(t).length !== l) return !1;
      for (;l--; ) if (u = c[l], !y.has(t, u) || !j(e[u], t[u], i, n)) return !1;
    }
  ...
  var E = {
    ...
    "'":"&#x27;",
    "`":"&#x60;"
  }, F = y.invert(E), O = function(e) {
    var t = function(t) {
      return e[t];
    }, i = "(?:" + y.keys(e).join("|") + ")", n = RegExp(i), r = RegExp(i, "g");
    return function(e) {
      return e = null == e ? "" :"" + e, n.test(e) ? e.replace(r, t) :e;
    };
  };
  y.escape = O(E), y.unescape = O(F), y.result = function(e, t, i) {
  ...
  y.template = function(e, t, i) {
    ...
    var n = RegExp([ (t.escape || z).source, (t.interpolate || z).source, (t.evaluate || z).source ].join("|") + "|$", "g"), r = 0, o = "__p+='";
    e.replace(n, function(t, i, n, s, a) {
      return o += e.slice(r, a).replace(R, H), r = a + t.length, i ? o += "'+\n((__t=(" + i + "))==null?'':_.escape(__t))+\n'" :n ? o += "'+\n((__t=(" + n + "))==null?'':__t)+\n'" :s && (o += "';\n" + s + "\n__p+='"), 
      t;
  ...
  y.mixin = function(e) {
    y.each(y.functions(e), function(t) {
      ...
      y.prototype[t] = function() {
        var e = [ this._wrapped ];
        return u.apply(e, arguments), W(this, i.apply(y, e));
      };
    });
  ...
  var n = t.prototype.trim, r = t.prototype.trimRight, o = t.prototype.trimLeft, s = function(e) {
    return 1 * e || 0;
  }, a = function(e, t) {
    if (t < 1) return "";
    for (var i = ""; t > 0; ) 1 & t && (i += e), t >>= 1, e += e;
    return i;
  }, l = [].slice, u = function(e) {
  ...
  var f = function() {
    ...
    return n.format = function(n, r) {
      var o, s, a, l, u, c, d, h = 1, p = n.length, m = "", g = [];
      for (s = 0; s < p; s++) if ("string" === (m = e(n[s]))) g.push(n[s]); else if ("array" === m) {
        if (l = n[s], l[2]) for (o = r[h], a = 0; a < l[2].length; a++) {
          if (!o.hasOwnProperty(l[2][a])) throw new Error(f('[_.sprintf] property "%s" does not exist', l[2][a]));
          o = o[l[2][a]];
        } else o = l[1] ? r[l[1]] :r[h++];
        if (/[^s]/.test(l[8]) && "number" != e(o)) throw new Error(f("[_.sprintf] expecting number but found %s", e(o)));
        switch (l[8]) {
         case "b":
          o = o.toString(2);
          break;
        ...
        d = l[6] - t(o).length, u = l[6] ? i(c, d) :"", g.push(l[5] ? o + u :u + o);
      }
      return g.join("");
    ...
    trim:function(e, i) {
      return null == e ? "" :!i && n ? n.call(e) :(i = u(i), t(e).replace(new RegExp("^" + i + "+|" + i + "+$", "g"), ""));
    },
    ltrim:function(e, i) {
      return null == e ? "" :!i && o ? o.call(e) :(i = u(i), t(e).replace(new RegExp("^" + i + "+"), ""));
    },
    rtrim:function(e, i) {
      return null == e ? "" :!i && r ? r.call(e) :(i = u(i), t(e).replace(new RegExp(i + "+$"), ""));
    },
    ...
    prune:function(e, i, n) {
      ...
      }, o = e.slice(0, i + 1).replace(/.(?=\W*\w*$)/g, r);
      return o = o.slice(o.length - 2).match(/\w\w/) ? o.replace(/\s*\S+$/, "") :p.rtrim(o.slice(0, o.length - 1)), 
      (o + n).length > e.length ? e :e.slice(0, o.length) + n;
    },
    words:function(e, t) {
    ...
    pad:function(e, i, n, r) {
      ...
      switch (n ? n.length > 1 && (n = n.charAt(0)) :n = " ", r) {
       case "right":
        return o = i - e.length, e + a(n, o);

       case "both":
        return o = i - e.length, a(n, Math.ceil(o / 2)) + e + a(n, Math.floor(o / 2));

       default:
        return o = i - e.length, a(n, o) + e;
      }
    },
    lpad:function(e, t, i) {
      return p.pad(e, t, i);
    ...
    numberFormat:function(e, t, i, n) {
      ...
      var r = e.split("."), o = r[0], s = r[1] ? (i || ".") + r[1] :"";
      return o.replace(/(\d)(?=(?:\d{3})+$)/g, "$1" + n) + s;
    },
    ...
    toSentence:function(e, t, i, n) {
      ...
      return e.length > 2 && n && (i = p.rtrim(t) + i), r.length ? r.join(t) + i + o :o;
    },
    ...
    slugify:function(e) {
      if (null == e) return "";
      var i = "\u0105\xe0\xe1\xe4\xe2\xe3\xe5\xe6\u0103\u0107\u0119\xe8\xe9\xeb\xea\xec\xed\xef\xee\u0142\u0144\xf2\xf3\xf6\xf4\xf5\xf8\u015b\u0219\u021b\xf9\xfa\xfc\xfb\xf1\xe7\u017c\u017a", n = new RegExp(u(i), "g");
    ...
    naturalCmp:function(e, i) {
      ...
      if (!e) return -1;
      if (!i) return 1;
      for (var n = /(\.\d+)|(\d+)|(\D+)/g, r = t(e).toLowerCase().match(n), o = t(i).toLowerCase().match(n), s = Math.min(r.length, o.length), a = 0; a < s; a++) {
        var l = r[a], u = o[a];
        if (l !== u) {
          var c = parseInt(l, 10);
          if (!isNaN(c)) {
      ...
      return r.length === o.length ? r.length - o.length :e < i ? -1 :1;
    },
    levenshtein:function(e, i) {
      ...
      e = t(e), i = t(i);
      for (var n, r, o = [], s = 0; s <= i.length; s++) for (var a = 0; a <= e.length; a++) r = s && a ? e.charAt(a - 1) === i.charAt(s - 1) ? n :Math.min(o[a], o[a - 1], n) + 1 :s + a, 
      n = o[a], o[a] = r;
      return o.pop();
    },
  ...
  e = function() {
    ...
    e.register = function(e, t) {
      ...
      for (i = document.querySelectorAll("[data-featurette]"), t = [], a = 0, u = i.length; a < u; a++) e = i[a], 
      e.featuretteLoading || e.featurette || (t.push(e), e.featuretteLoading = !0);
      for (d = [], l = 0, c = t.length; l < c; l++) e = t[l], n = e.getAttribute("data-featurette"), 
      o = this.registered_features[n], o ? (r = e.id, null != r && "" !== r || (r = "featurette-" + this.featurettes_counter, 
  ...
  function h(e, i) {
    var n;
    return i.wrapperClass ? (n = t("<span />").addClass(i.wrapperClass), n = c(e, n, "wrap")) :null;
  }
  function f() {
    var i, n, r, o;
    return o = "rgb(120,2,153)", n = t('<div style="width:0;height:0;color:' + o + '">'), 
  ...
  function w(e, t, i) {
    ...
    }), i(); n.length; ) r = n.pop(), r.el.style[r.name] = r.old;
  }
  function _(e, t) {
    var i;
    i = e.parents(), i.push(e[0]), i = i.not(":visible"), w(i, {
      visibility:"hidden",
      display:"block",
      position:"absolute"
    }, t);
  ...
  var S = !0, k = !1, T = [ {
    ...
    apply:function(t, i) {
      ...
      return l = i.submitDefaultHtml, t.is(":reset") && (l = i.resetDefaultHtml), h = t.is("a, button") ? function() {
        ...
        "click touchend":function() {
          ...
          i.initEvent("click", !0, !0), r = t[0].dispatchEvent(i), t.is("a") && r && (o = n(t, "target"), 
          s = n(t, "href"), o && "_self" !== o ? e.open(s, o) :document.location.href = s)) :t.click(), 
          f = !1);
        }
      }), b(a, i), {
        remove:function() {
    ...
    apply:function(e, i) {
      ...
      return l = d(e, i, {
        ...
        spanWrap:"after"
      }), h = l.div, p = l.span, f = t("<span />").html(i.fileDefaultHtml), f.addClass(i.filenameClass), 
  ...
  m() && !g() && (S = !1), t.uniform = {
    ...
    S ? (i.resetSelector && t(i.resetSelector).mouseup(function() {
      ...
      var e, n, r, o = t(this);
      if (o.data("uniformed")) return void t.uniform.update(o);
      for (e = 0; e < T.length; e += 1) if (n = T[e], n.match(o, i)) return r = n.apply(o, i), 
  ...
  n = function() {
    ...
    return e.prototype.add_node = function(e) {
      ...
      for (t = this.parsed.length, this.parsed.push({
        ...
        disabled:e.disabled,
        classes:e.className
      }), o = e.childNodes, s = [], i = 0, n = o.length; i < n; i++) r = o[i], s.push(this.add_option(r, t, e.disabled));
      return s;
    ...
    var t, i, r, o, s;
    for (o = new n(), s = e.childNodes, i = 0, r = s.length; i < r; i++) t = s[i], o.add_node(t);
    return o.parsed;
  }, t = function() {
    function e(t, i) {
    ...
    return e.prototype.set_default_values = function() {
      ...
      var t, i, n, r, o, s, a;
      for (t = "", a = 0, s = this.results_data, r = 0, o = s.length; r < o && (i = s[r], 
      ...
      var e, t, i, n, r;
      for (i = this.results_data, r = [], e = 0, t = i.length; e < t; e++) n = i[e], n.selected ? r.push(n.selected = !1) :r.push(void 0);
      return r;
      ...
      var e, t, i, n, r, o, s, a, l, u, c, d, h, f, p;
      for (this.no_results_clear(), u = 0, s = this.get_search_text(), e = s.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), 
      l = this.get_search_regex(e), a = this.results_data, i = 0, n = a.length; i < n; i++) r = a[i], 
      r.search_match = !1, c = null, d = null, r.highlighted_html = "", this.include_option_in_results(r) && (r.group && (r.group_match = !1, 
      r.active_options = 0), null != r.group_array_index && this.results_data[r.group_array_index] && (c = this.results_data[r.group_array_index], 
      0 === c.active_options && c.search_match && (u += 1), c.active_options += 1), p = r.group ? r.label :r.text, 
      r.group && !this.group_search || (d = this.search_string_match(p, l), r.search_match = null != d, 
      r.search_match && !r.group && (u += 1), r.search_match ? (s.length && (h = d.index, 
      o = p.slice(0, h), t = p.slice(h, h + s.length), f = p.slice(h + s.length), r.highlighted_html = this.escape_html(o) + "<em>" + this.escape_html(t) + "</em>" + this.escape_html(f)), 
      null != c && (c.group_match = !0)) :null != r.group_array_index && this.results_data[r.group_array_index].search_match && (r.search_match = !0)));
      return this.result_clear_highlight(), u < 1 && s.length ? (this.update_results_content(""), 
    ...
    chosen:function(n) {
      return t.browser_is_supported() ? this.each(function() {
        var t, r;
        if (t = e(this), r = t.data("chosen"), "destroy" === n) return void (r instanceof i && r.destroy());
        r instanceof i || t.data("chosen", new i(this, n));
      }) :this;
    }
  }), i = function(t) {
    function i() {
    ...
    return o(i, t), i.prototype.setup = function() {
      ...
      if (e.length) {
        ...
        n = parseInt(this.search_results.css("maxHeight"), 10), o = this.search_results.scrollTop(), 
        r = n + o, i = this.result_highlight.position().top + this.search_results.scrollTop(), 
        (t = i + this.result_highlight.outerHeight()) >= r) return this.search_results.scrollTop(t - n > 0 ? t - n :0);
      ...
      if (this.is_multiple) {
        ...
        i = 0, n = s.length; i < n; i++) r = s[i], o[r] = this.search_field.css(r);
        return t = e("<div />").css(o), t.text(this.get_search_field_value()), e("body").append(t), 
  ...
  function t(t, n, r) {
    ...
    return this.on("click.pjax", t, function(t) {
      var s = e.extend({}, m(n, r));
      s.container || (s.container = e(this).attr("data-pjax") || o), i(t, s);
    });
  }
  function i(t, i, n) {
    n = m(i, n);
    ...
    if (!(t.which > 1 || t.metaKey || t.ctrlKey || t.shiftKey || t.altKey || location.protocol !== o.protocol || location.hostname !== o.hostname || o.href.indexOf("#") > -1 && p(o) == p(location) || t.isDefaultPrevented())) {
      var s = {
        ...
        target:o
      }, a = e.extend({}, s, n), l = e.Event("pjax:click");
  ...
  function n(t, i, n) {
    ...
    if ("GET" !== s.type && window.FormData !== undefined) s.data = new FormData(o), 
    s.processData = !1, s.contentType = !1; else {
      if (e(o).find(":file").length) return;
      s.data = e(o).serializeArray();
    }
  ...
  function r(t) {
    ...
    var n = t.target, o = f(t.url).hash, a = t.context = g(t.container);
    ...
    t.beforeSend = function(e, n) {
      ...
      var r = f(n.url);
      o && (r.hash = o), t.requestUrl = h(r);
    }, t.complete = function(e, n) {
      l && clearTimeout(l), i("pjax:complete", [ e, n, t ]), i("pjax:end", [ e, t ]);
    }, t.error = function(e, n, r) {
      var o = b("", e, t), a = i("pjax:error", [ e, n, r, t ]);
      "GET" == t.type && "abort" !== n && a && s(o.url);
    }, t.success = function(n, l, u) {
      var d = r.state, h = "function" == typeof e.pjax.defaults.version ? e.pjax.defaults.version() :e.pjax.defaults.version, p = u.getResponseHeader("X-PJAX-Version"), m = b(n, u, t), g = f(m.url);
      if (o && (g.hash = o, m.url = g.href), h && p && h !== p) return void s(m.url);
      ...
      v && document.activeElement !== v && v.focus(), x(m.scripts);
      var y = t.scrollTo;
      if (o) {
        var w = decodeURIComponent(o.slice(1)), _ = document.getElementById(w) || document.getElementsByName(w)[0];
        _ && (y = e(_).offset().top);
      }
      "number" == typeof y && e(window).scrollTop(y), i("pjax:success", [ n, l, u, t ]);
    }, r.state || (r.state = {
      id:c(),
    ...
    return p.readyState > 0 && (t.push && !t.replace && (w(r.state.id, d(a)), window.history.pushState(null, "", t.requestUrl)), 
    i("pjax:start", [ p, t ]), i("pjax:send", [ p, t ])), r.xhr;
  }
  function o(t, i) {
    var n = {
      url:window.location.href,
  ...
  function a(t) {
    ...
    if (o && o.container) {
      ...
      var a = P[o.id] || [], l = e(a[0] || o.container), c = a[1];
      if (l.length) {
        n && _(i, n.id, d(l));
        ...
        if (c) {
          l.trigger("pjax:start", [ null, f ]), r.state = o, o.title && (document.title = o.title);
  ...
  function b(t, i, n) {
    var r = {}, o = /<html/i.test(t), s = i.getResponseHeader("X-PJAX-URL");
    if (r.url = s ? h(f(s)) :n.requestUrl, o) var a = e(y(t.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0])), l = e(y(t.match(/<body[^>]*>([\s\S.]*)<\/body>/i)[0])); else var a = l = e(y(t));
    if (0 === l.length) return r;
    if (r.title = v(a, "title").last().text(), n.fragment) {
      if ("body" === n.fragment) var u = l; else var u = v(l, n.fragment).first();
      u.length && (r.contents = "body" === n.fragment ? u :u.contents(), r.title || (r.title = u.attr("title") || u.data("title")));
    } else o || (r.contents = l);
    return r.contents && (r.contents = r.contents.not(function() {
      return e(this).is("title");
    }), r.contents.find("title").remove(), r.scripts = v(r.contents, "script[src]").remove(), 
    r.contents = r.contents.not(r.scripts)), r.title && (r.title = e.trim(r.title)), 
    r;
  }
  function x(t) {
    if (t) {
  ...
  function w(e, t) {
    P[e] = t, j.push(e), C(I, 0), C(j, r.defaults.maxCacheLength);
  }
  function _(e, t, i) {
    var n, o;
    P[t] = i, "forward" === e ? (n = j, o = I) :(n = I, o = j), n.push(t), (t = o.pop()) && delete P[t], 
    C(n, r.defaults.maxCacheLength);
  }
  function C(e, t) {
    for (;e.length > t; ) delete P[e.shift()];
  }
  function S() {
  ...
  function T() {
    e.fn.pjax = function() {
      return this;
    }, e.pjax = l, e.pjax.enable = k, e.pjax.disable = e.noop, e.pjax.click = e.noop, 
    e.pjax.submit = e.noop, e.pjax.reload = function() {
      window.location.reload();
    }, e(window).off("popstate.pjax", a);
  }
  var M = !0, D = window.location.href, A = window.history.state;
  A && A.container && (r.state = A), "state" in window.history && (M = !1);
  var P = {}, I = [], j = [];
  ...
  var i = {
    ...
    function s() {
      T = e(k), "true" != T.attr("data-mentions-input") && (M = T.parent(), A = e(o.templates.wrapper()), 
    ...
    function a() {
      D = e(o.templates.autocompleteList()), D.appendTo(A), D.delegate("li", "mousedown", p);
    }
    function l() {
      P = e(o.templates.mentionsOverlay()), P.prependTo(A);
    }
    function u() {
      var e = f();
      t.each(E, function(t) {
      ...
      t.each(E, function(e) {
        ...
        i = i.replace(s, a);
      }), i = i.replace(/\n/g, "<br />"), i = i.replace(/ {2}/g, "&nbsp; "), T.data("messageText", e), 
      P.find("div").html(i);
    }
    function c() {
      O = [];
    ...
    function b(n) {
      ...
      if (n.keyCode == i.BACKSPACE) return void (O = O.slice(0, -1 + O.length));
      if (!D.is(":visible")) return !0;
      switch (n.keyCode) {
       case i.UP:
       case i.DOWN:
        var r = null;
        return r = n.keyCode == i.DOWN ? I && I.length ? I.next() :D.find("li").first() :e(I).prev(), 
        r.length && w(r), !1;
    ...
    function _(i, n) {
      ...
      t.each(n, function(n, s) {
        ...
        if (0 === s && w(u), o.showAvatars) {
          var c;
          c = e(n.avatar ? o.templates.autocompleteListItemAvatar({
            avatar:n.avatar,
            type:n.type
          }) :o.templates.autocompleteListItemIcon({
            icon:n.icon
  ...
  var e = {}, t = null, i = null, n = null, r = null, o = {}, s = Math.ceil(window.devicePixelRatio) || 1, a = 16 * s, l = {
    width:7,
    height:9,
    font:10 * s + "px arial",
    color:"#ffffff",
    ...
    ie:u("trident"),
    chrome:u("chrome"),
    webkit:u("chrome") || u("safari"),
    safari:u("safari") && !u("chrome"),
    mozilla:u("mozilla") && !u("chrome") && !u("safari")
  }, d = function() {
    ...
    return r || (r = document.createElement("canvas"), r.width = a, r.height = a), r;
  }, m = function(e) {
    if (e) {
      h();
    ...
    if (!p().getContext || c.ie || c.safari || "force" === o.fallback) return v(e);
    var i = p().getContext("2d"), t = t || "#000000", r = f();
    n = document.createElement("img"), n.onload = function() {
      ...
      b();
    }, !r.match(/^data/) && o.crossOrigin && (n.crossOrigin = "anonymous"), n.src = r;
  }, v = function(e) {
    if (o.fallback) {
    ...
    "number" == typeof t && t > 99 && o.abbreviate && (t = x(t));
    var i = (t + "").length - 1, n = o.width * s + 6 * s * i, r = o.height * s, l = a - r, u = a - n - s, d = 16 * s, h = 16 * s, f = 2 * s;
    e.font = (c.webkit ? "bold " :"") + o.font, e.fillStyle = o.background, e.strokeStyle = o.background, 
    e.lineWidth = s, e.beginPath(), e.moveTo(u + f, l), e.quadraticCurveTo(u, l, u, l + f), 
    e.lineTo(u, d - f), e.quadraticCurveTo(u, d, u + f, d), e.lineTo(h - f, d), e.quadraticCurveTo(h, d, h, d - f), 
    e.lineTo(h, l + f), e.quadraticCurveTo(h, l, h - f, l), e.closePath(), e.fill(), 
    e.beginPath(), e.strokeStyle = "rgba(0,0,0,0.3)", e.moveTo(u + f / 2, d), e.lineTo(h - f / 2, d), 
    e.stroke(), e.fillStyle = o.color, e.textAlign = "right", e.textBaseline = "top", 
    e.fillText(t, 2 === s ? 29 :15, c.mozilla ? 7 * s :6 * s);
  }, b = function() {
  ...
  e.setOptions = function(e) {
    o = {}, e.colour && (e.color = e.colour);
    for (var t in l) o[t] = e.hasOwnProperty(t) ? e[t] :l[t];
    return this;
      ...
      i._set("bar", {
        ...
        e.controllers.bar = e.DatasetController.extend({
          ...
          updateElementGeometry:function(e, t, i) {
            ...
            r.horizontal = a, r.base = i ? s :u.base, r.x = a ? i ? s :u.head :c.center, r.y = a ? c.center :i ? s :u.head, 
            r.height = a ? c.size :void 0, r.width = a ? void 0 :c.size;
          },
          ...
          calculateBarIndexPixels:function(e, t, i) {
            ...
            p = w, g = (f = i).pixels, v = g[h], y = h > 0 ? g[h - 1] :null, b = h < g.length - 1 ? g[h + 1] :null, 
        ...
        update:function(e, t, o) {
          ...
          if (e) {
            ...
            r.each(p.concat(m, g, v), function(e) {
              ...
              i ? (t = e.update(e.fullWidth ? b :S, C), k -= t.height) :(t = e.update(_, k), S -= t.width), 
              T.push({
                horizontal:i,
                minSize:t,
                box:e
      ...
      r._set("scale", {
        ...
        e.Scale = o.extend({
          ...
          getPixelForDecimal:function(e) {
            var t = this;
            if (t.isHorizontal()) {
              var i = (t.width - (t.paddingLeft + t.paddingRight)) * e + t.paddingLeft, n = t.left + Math.round(i);
            ...
            if (i.display) {
              ...
              if (s.each(g, function(r, o) {
                if (!s.isNullOrUndef(r.label)) {
                  ...
                  if (m) {
                    var R = w + L;
                    "bottom" === i.position ? (z = p ? "middle" :"top", N = p ? "right" :"center", F = t.top + R) :(z = p ? "middle" :"bottom", 
                    N = p ? "left" :"center", F = t.bottom - R);
        ...
        e.Tooltip = n.extend({
          ...
          update:function(t) {
            ...
            if (D.length) {
              ...
              var N = [];
              for (i = 0, n = D.length; i < n; ++i) N.push((b = D[i], x = void 0, w = void 0, 
              x = b._xScale, w = b._yScale || b._scale, _ = b._index, C = b._datasetIndex, {
        ...
        addEventListener:function(e, t, i) {
          ...
          if ("resize" !== t) {
            ...
            n(r, t, (a.proxies || (a.proxies = {}))[e.id + "_" + t] = function(t) {
              var n, r, s, a;
              i((r = e, s = p[(n = t).type] || n.type, a = l.getRelativePosition(n, r), o(s, r, a.x, a.y, n)));
            });
          } else s(r, i, e);
        },
    ...
    50:[ function(e, t) {
      ...
      t.exports = {
        ...
        afterDatasetsUpdate:function(e, t) {
          ...
          h = (d = u).fill, f = "dataset", !1 === h ? null :(isFinite(h) || (f = "boundary"), 
          c[f](d))));
        },
      ...
      t.exports = function(e) {
        var t = e.Scale.extend({
          ...
          buildTicks:function() {
            ...
            return x.min = w, x.max = _, x._unit = S.unit || function(e, t, i, n) {
            ...
            }(T, S.minUnit, x.min, x.max), x._majorUnit = a(x._unit), x._table = function(e, t, i, n) {
              ...
              var r, o, s, a, l, u = [], c = [ t ];
              for (r = 0, o = e.length; r < o; ++r) (a = e[r]) > t && a < i && c.push(a);
              for (c.push(i), r = 0, o = c.length; r < o; ++r) l = c[r + 1], s = c[r - 1], a = c[r], 
              void 0 !== s && void 0 !== l && Math.round((l + s) / 2) === a || u.push({
                time:a,
                pos:r / (o - 1)
              });
              return u;
            }(x._timestamps.data, w, _, C.distribution), x._offsets = (n = x._table, c = T, 
            d = w, h = _, y = 0, b = 0, (f = C).offset && c.length && (f.time.min || (g = c.length > 1 ? c[1] :h, 
  ...
  return function(e, t, i) {
    ...
    i.namespaces = {
      ...
      for (e = e || {}, t = 1; t < arguments.length; t++) {
        n = arguments[t];
        for (var o in n) r = n[o], "object" != typeof r || null === r || r instanceof Array ? e[o] = r :e[o] = i.extend(e[o], r);
      }
      return e;
      ...
      var d = i.projectLength(e, c.step, c), h = d < n, f = r ? i.rho(c.range) :0;
      if (r && i.projectLength(e, 1, c) >= n) c.step = 1; else if (r && f < c.step && i.projectLength(e, f, c) >= n) c.step = f; else for (;;) {
      ...
      var p = 2.221e-16;
      for (c.step = Math.max(c.step, p), a = c.min, l = c.max; a + c.step <= c.low; ) a = o(a, c.step);
      for (;l - c.step >= c.high; ) l = o(l, -c.step);
      c.min = a, c.max = l, c.range = c.max - c.min;
      var m = [];
      for (s = c.min; s <= c.max; s = o(s, c.step)) {
        var g = i.roundWithPrecision(s);
      ...
      function o(t) {
        ...
        if (a = i.extend({}, u), n) for (l = 0; l < n.length; l++) {
          var s = e.matchMedia(n[l][0]);
          s.matches && (a = i.extend(a, n[l][1]));
        }
    ...
    i.Interpolation = {}, i.Interpolation.none = function(e) {
      ...
      return function t(o, s) {
        ...
        if (a.length) {
          ...
          if (o = a[0].pathCoordinates, s = a[0].valueData, o.length <= 4) return i.Interpolation.none()(o, s);
          for (var u, c = new i.Svg.Path().move(o[0], o[1], !1, s[0]), d = 0, h = o.length; h - 2 * !u > d; d += 2) {
            var f = [ {
              x:+o[d - 2],
              y:+o[d - 1]
            }, {
      ...
      return e = i.extend({}, t, e), function t(n, r) {
        ...
        if (o.length) {
          ...
          if (n = o[0].pathCoordinates, r = o[0].valueData, n.length <= 4) return i.Interpolation.none()(n, r);
          var a, l, u = [], c = [], d = n.length / 2, h = [], f = [], p = [], m = [];
          for (a = 0; a < d; a++) u[a] = n[2 * a], c[a] = n[2 * a + 1];
    ...
    function C(e, t, n) {
      return t === undefined && (t = !0), Object.keys(e).forEach(function(r) {
        function o(e, t) {
          ...
          e.keySplines = a.join(" "), e.keyTimes = "0;1"), t && (e.fill = "freeze", l[r] = e.from, 
          this.attr(l), s = i.quantity(e.begin || 0).value, e.begin = "indefinite"), o = this.elem("animate", i.extend({
            attributeName:r
    ...
    function n(e) {
      ...
      t.raw.series.forEach(function(o, s) {
        ...
        }, f = "function" == typeof h.lineSmooth ? h.lineSmooth :h.lineSmooth ? i.Interpolation.monotoneCubic() :i.Interpolation.none(), p = f(c, d);
        if (h.showPoint && p.pathElements.forEach(function(t) {
          var a = l.elem("line", {
            x1:t.x,
            y1:t.y,
            x2:t.x + .01,
        ...
        if (h.showArea && r.range) {
          var g = Math.max(Math.min(h.areaBase, r.range.max), r.range.min), v = u.y1 - r.projectValue(g);
        ...
        if (0 !== u.normalized.series[s] || !e.ignoreEmptyValues) {
          ...
          if (x.attr({
            ...
            w = 1 === u.raw.series.length ? {
              x:f.x,
              y:f.y
            } :i.polarToCartesian(f.x, f.y, a, d + (m - d) / 2);
            var _;
            _ = u.normalized.labels && !i.isFalseyButZero(u.normalized.labels[s]) ? u.normalized.labels[s] :u.normalized.series[s];
    ...
    i.plugins = i.plugins || {}, i.plugins.tooltip = function(u) {
      return u = i.extend({}, l, u), function(l) {
        ...
        function d(t) {
          ...
          var i, n, r = -g / 2 + u.tooltipOffset.x, o = -m + u.tooltipOffset.y;
        ...
        p || (p = t.createElement("div"), p.className = u["class"] ? "chartist-tooltip " + u["class"] :"chartist-tooltip", 
        u.appendToBody ? t.body.appendChild(p) :f.appendChild(p));
        var m = p.offsetHeight, g = p.offsetWidth;
        r(p), c("mouseover", h, function(e) {
          var r = e.target, o = "", c = l instanceof i.Pie ? r :r.parentNode, h = c ? r.parentNode.getAttribute("ct:meta") || r.parentNode.getAttribute("ct:series-name") :"", f = r.getAttribute("ct:meta") || h || "", v = !!f, y = r.getAttribute("ct:value");
          if (u.transformTooltipTextFnc && "function" == typeof u.transformTooltipTextFnc && (y = u.transformTooltipTextFnc(y)), 
          u.tooltipFnc && "function" == typeof u.tooltipFnc) o = u.tooltipFnc(f, y); else {
            if (u.metaIsHTML) {
              var b = t.createElement("textarea");
              b.innerHTML = f, f = b.value;
            }
            if (f = '<span class="chartist-tooltip-meta">' + f + "</span>", v) o += f + "<br>"; else if (l instanceof i.Pie) {
              var x = s(r, "ct-label");
              x && (o += a(x) + "<br>");
            }
            y && (u.currency && (y = u.currencyFormatCallback != undefined ? u.currencyFormatCallback(y, u) :u.currency + y.replace(/(\d)(?=(\d{3})+(?:\.\d+)?$)/g, "$1,")), 
            y = '<span class="chartist-tooltip-value">' + y + "</span>", o += y);
          }
...
!function(e, t) {
  ...
  function n(e, t, i, n) {
    ...
    var s, a = new r();
    a.subs = new o(), a.subsText = {}, a.ib();
    for (s in t) a.subs[s] = t[s], a.subsText[s] = n;
  ...
  e.Template = function(e, t, i, n) {
    ...
    rs:function(e, t, i) {
      var n = e[e.length - 1];
      if (!h(n)) return void i(e, t, this);
      for (var r = 0; r < n.length; r++) e.push(n[r]), i(e, t, this), e.pop();
    },
    ...
    d:function(e, t, n, r) {
      ...
      if ("." === e && h(t[t.length - 2])) a = t[t.length - 1]; else for (var c = 1; c < s.length; c++) o = i(s[c], a, l), 
      null != o ? (u = a, a = o) :a = "";
      return !(r && !a) && (r || "function" != typeof a || (t.push(u), a = this.mv(a, t, n), 
      t.pop()), a);
    },
    f:function(e, t, n, r) {
      for (var o = !1, s = null, a = !1, l = this.options.modelGet, u = t.length - 1; u >= 0; u--) if (s = t[u], 
      null != (o = i(e, s, l))) {
        a = !0;
        break;
      }
      return a ? (r || "function" != typeof o || (o = this.mv(o, t, n)), o) :!r && "";
    },
  ...
  function d(e, t) {
    var i = "<" + (t.prefix || ""), n = i + e.n + x++;
    return t.partials[n] = {
      name:e.n,
      partials:{}
    }, t.code += 't.b(t.rp("' + u(n) + '",c,p,"' + (e.indent || "") + '"));', n;
  }
  function h(e, t) {
  ...
  e.tags = {
    ...
    function a() {
      for (var t = !0, i = w; i < y.length; i++) if (!(t = e.tags[y[i].tag] < e.tags._v || "_t" == y[i].tag && null === y[i].text.match(p))) return !1;
      return t;
    }
    function l(e, t) {
      if (s(), e && a()) for (var i, n = w; n < y.length; n++) y[n].text && ((i = y[n + 1]) && ">" == i.tag && (i.indent = y[n].text.toString()), 
    ...
    function u(e, t) {
      ...
      return _ = o[0], C = o[o.length - 1], r + n.length - 1;
    }
    var c = r.length, d = 0, h = 1, f = d, m = null, g = null, v = "", y = [], b = !1, x = 0, w = 0, _ = "{{", C = "}}";
    for (o && (o = o.split(" "), _ = o[0], C = o[1]), x = 0; x < c; x++) f == d ? n(_, r, x) ? (--x, 
    s(), f = h) :"\n" == r.charAt(x) ? l(b) :v += r.charAt(x) :f == h ? (x += _.length - 1, 
    g = e.tags[r.charAt(x + 1)], m = g ? r.charAt(x + 1) :"_v", "=" == m ? (x = u(r, x), 
    f = d) :(g && x++, f = 2), b = x) :n(C, r, x) ? (y.push({
      tag:m,
      n:i(v),
      otag:_,
      ctag:C,
      i:"/" == m ? b - _.length :x + C.length
    }), v = "", x += C.length - 1, f = d, "{" == m && ("}}" == C ? x++ :t(y[y.length - 1]))) :v += r.charAt(x);
    return l(b, !0), y;
  };
  var b = {
    _t:!0,
...
mejs.version = "2.23.5", mejs.meIndex = 0, mejs.plugins = {
  ...
  getScriptPath:function(e) {
    for (var t, i, n, r, o, s = 0, a = "", l = "", u = document.getElementsByTagName("script"), c = u.length, d = e.length; s < c; s++) {
      for (n = u[s].src, i = n.lastIndexOf("/"), i > -1 ? (o = n.substring(i + 1), r = n.substring(0, i + 1)) :(o = n, 
  ...
  calculateTimeFormat:function(e, t, i) {
    ...
    var n = t.timeFormat, r = n[0], o = n[1] == n[0], s = o ? 2 :1, a = ":", l = Math.floor(e / 3600) % 24, u = Math.floor(e / 60) % 60, c = Math.floor(e % 60), d = Math.floor((e % 1 * i).toFixed(3)), h = [ [ d, "f" ], [ c, "s" ], [ u, "m" ], [ l, "h" ] ];
    n.length < s && (a = n[s]);
    for (var f = !1, p = 0, m = h.length; p < m; p++) if (-1 !== n.indexOf(h[p][1])) f = !0; else if (f) {
      for (var g = !1, v = p; v < m; v++) if (h[v][0] > 0) {
        g = !0;
        break;
      }
      if (!g) break;
      o || (n = r + n), n = h[p][1] + a + n, o && (n = h[p][1] + n), r = h[p][1];
    }
  ...
  secondsToTimeCode:function(e, t) {
    ...
    void 0 === r && (r = 25);
    var n = t.currentTimeFormat, o = Math.floor(e / 3600) % 24, s = Math.floor(e / 60) % 60, a = Math.floor(e % 60), l = Math.floor((e % 1 * r).toFixed(3));
    lis = [ [ l, "f" ], [ a, "s" ], [ s, "m" ], [ o, "h" ] ];
    var u = n;
    for (i = 0, len = lis.length; i < len; i++) u = u.replace(lis[i][1] + lis[i][1], this.twoDigitsString(lis[i][0])), 
  ...
  init:function() {
    var e, t, i = this, n = document, r = mejs.PluginDetector.nav, o = mejs.PluginDetector.ua.toLowerCase(), s = [ "source", "track", "audio", "video" ];
    i.isiPad = null !== o.match(/ipad/i), i.isiPhone = null !== o.match(/iphone/i), 
    i.isiOS = i.isiPhone || i.isiPad, i.isAndroid = null !== o.match(/android/i), i.isBustedAndroid = null !== o.match(/android 2\.[12]/), 
    i.isBustedNativeHTTPS = "https:" === location.protocol && (null !== o.match(/android [12]\./) || null !== o.match(/macintosh.* version.* safari/)), 
    i.isIE = -1 != r.appName.toLowerCase().indexOf("microsoft") || null !== r.appName.toLowerCase().match(/trident/gi), 
    i.isChrome = null !== o.match(/chrome/gi), i.isChromium = null !== o.match(/chromium/gi), 
    i.isFirefox = null !== o.match(/firefox/gi), i.isWebkit = null !== o.match(/webkit/gi), 
    i.isGecko = null !== o.match(/gecko/gi) && !i.isWebkit && !i.isIE, i.isOpera = null !== o.match(/opera/gi), 
  ...
  create:function(e, t) {
    ...
    for (n in t) r[n] = t[n];
    return l = void 0 === l || null === l || "" == l ? null :l, u = void 0 === u || null === u ? "" :u, 
    d = void 0 === d || null === d || "false" === d ? "none" :d, c = !(void 0 === c || null === c || "false" === c), 
    h = !(void 0 === h || null === h || "false" === h), i = this.determinePlayback(o, r, mejs.MediaFeatures.supportsMediaTag, a, l), 
  ...
  determinePlayback:function(e, t, i, n, r) {
    ...
    if ("undefined" != typeof t.type && "" !== t.type) if ("string" == typeof t.type) g.push({
      ...
      type:c,
      url:r
    }); else for (o = 0; o < e.childNodes.length; o++) u = e.childNodes[o], 1 == u.nodeType && "source" == u.tagName.toLowerCase() && (r = u.getAttribute("src"), 
    ...
    s = 0; s < t.plugins.length; s++) for (d = t.plugins[s], h = mejs.plugins[d], a = 0; a < h.length; a++) if (f = h[a], 
    null == f.version || mejs.PluginDetector.hasPluginVersion(d, f.version)) for (l = 0; l < f.types.length; l++) if (c.toLowerCase() == f.types[l].toLowerCase()) return v.method = d, 
    v.url = g[o].url, v;
  ...
  createPlugin:function(e, t, i, n, r, o) {
    ...
    switch (e.method) {
     ...
     case "youtube":
      var x;
      if (-1 != e.url.lastIndexOf("youtu.be")) x = e.url.substr(e.url.lastIndexOf("/") + 1), 
      -1 != x.indexOf("?") && (x = x.substr(0, x.indexOf("?"))); else {
        var w = e.url.match(/[?&]v=([^&#]+)|&|#|$/);
        w && (x = w[1]);
      }
      youtubeSettings = {
...
Zepto.fn.outerWidth = function(e) {
  ...
  mejs.MepDefaults = {
    ...
    meReady:function(t, i) {
      var n, r, o = this, s = mejs.MediaFeatures, a = i.getAttribute("autoplay"), l = !(void 0 === a || null === a || "false" === a);
      if (!o.created) {
        if (o.created = !0, o.media = t, o.domNode = i, !(s.isAndroid && o.options.AndroidUseNativeControls || s.isiPad && o.options.iPadUseNativeControls || s.isiPhone && o.options.iPhoneUseNativeControls)) {
          ...
          o.buildposter(o, o.controls, o.layers, o.media), o.buildkeyboard(o, o.controls, o.layers, o.media), 
          o.buildoverlays(o, o.controls, o.layers, o.media), o.findTracks();
          for (n in o.options.features) if (r = o.options.features[n], o["build" + r]) try {
    ...
    setResponsiveMode:function() {
      ...
      }(), r = t.container.parent().closest(":visible").width(), o = t.container.parent().closest(":visible").height(), s = t.isVideo || !t.options.autosizeProgress ? parseInt(r * n / i, 10) :n;
    ...
    setPoster:function(t) {
      var i = this, n = i.container.find(".mejs-poster"), r = n.find("img");
      0 === r.length && (r = e('<img width="100%" height="100%" alt="" />').appendTo(n)), 
      r.attr("src", t), n.css({
    ...
    setSrc:function(e) {
      ...
      if ("youtube" === t.media.pluginType) {
        ...
        if ("string" != typeof e) {
          var n, r;
          for (n = 0; n < e.length; n++) if (r = e[n], this.canPlayType(r.type)) {
            e = r.src;
            break;
          }
        }
    ...
    mejs.MediaElementPlayer.prototype.globalBind = function(i, n, r) {
      ...
      i = t(i, o.id), i.d && e(s).bind(i.d, n, r), i.w && e(window).bind(i.w, n, r);
    }, mejs.MediaElementPlayer.prototype.globalUnbind = function(i, n) {
      var r = this, o = r.node ? r.node.ownerDocument :document;
      i = t(i, r.id), i.d && e(o).unbind(i.d, n), i.w && e(window).unbind(i.w, n);
    };
  ...
  e.extend(mejs.MepDefaults, {
    ...
    buildprogress:function(t, i, n, r) {
      var o = this, s = !1, a = !1, l = 0, u = !1, c = t.options.autoRewind, d = (o.options.progressHelpText ? o.options.progressHelpText :mejs.i18n.t("mejs.time-help-text"), 
      ...
      e('<div class="mejs-time-rail"><span  class="mejs-time-total mejs-time-slider"><span class="mejs-time-buffering"></span><span class="mejs-time-loaded"></span><span class="mejs-time-current"></span><span class="mejs-time-handle"></span>' + d + "</span></div>").appendTo(i), 
      ...
      var h = function(e) {
        ...
        r.duration && (i < n.left ? i = n.left :i > a + n.left && (i = a + n.left), c = i - n.left, 
        l = c / a, u = l <= .02 ? 0 :l * r.duration, s && u !== r.currentTime && r.setCurrentTime(u), 
        mejs.MediaFeatures.hasTouch || (o.timefloat.css("left", c), o.timefloatcurrent.html(mejs.Utility.secondsToTimeCode(u, t.options)), 
        o.timefloat.show()));
      }, f = function() {
      ...
      o.slider.bind("focus", function() {
        ...
        new Date() - l >= 1e3 && (u = r.paused);
        var i = e.keyCode, n = r.duration, o = r.currentTime, s = t.options.defaultSeekForwardInterval(r), a = t.options.defaultSeekBackwardInterval(r);
        switch (i) {
         case 37:
         case 40:
          o -= a;
        ...
        return o = o < 0 ? 0 :o >= n ? n :Math.floor(o), l = new Date(), u || r.pause(), 
        o < r.duration && !u && setTimeout(p, 1100), r.setCurrentTime(o), e.preventDefault(), 
        e.stopPropagation(), !1;
      }), o.total.bind("mousedown touchstart", function(e) {
        1 !== e.which && 0 !== e.which || (s = !0, h(e), o.globalBind("mousemove.dur touchmove.dur", function(e) {
          h(e);
        }), o.globalBind("mouseup.dur touchend.dur", function() {
          s = !1, "undefined" != typeof o.timefloat && o.timefloat.hide(), o.globalUnbind(".dur");
        }));
      }).bind("mouseenter", function() {
        a = !0, o.globalBind("mousemove.dur", function(e) {
          h(e);
        }), "undefined" == typeof o.timefloat || mejs.MediaFeatures.hasTouch || o.timefloat.show();
      }).bind("mouseleave", function() {
        a = !1, s || (o.globalUnbind(".dur"), "undefined" != typeof o.timefloat && o.timefloat.hide());
    ...
    enterFullScreen:function() {
      ...
      t.isInIframe && setTimeout(function i() {
        if (t.isNativeFullScreen) {
          var n = e(window).width(), r = screen.width;
          Math.abs(r - n) > r * .002 ? t.exitFullScreen() :setTimeout(i, 500);
        }
  ...
  e.extend(mejs.MepDefaults, {
    ...
    buildspeed:function(t, i, n, r) {
      ...
      if ("native" == o.media.pluginType) {
        ...
        g += "</ul></div></div>", s = e(g).appendTo(i), a = s.find(".mejs-speed-selector"), 
  ...
  e.extend(mejs.MepDefaults, {
    ...
    drawChapters:function(t) {
      ...
      o = Math.floor(n / r.media.duration * 100), (o + s > 100 || i == t.entries.times.length - 1 && o + s < 100) && (o = 100 - s), 
      ...
      parse:function(t) {
        for (var i, n, r, o = 0, s = mejs.TrackFormatParser.split2(t, /\r?\n/), a = {
          ...
          if ((i = this.pattern_timecode.exec(s[o])) && o < s.length) {
            for (o - 1 >= 0 && "" !== s[o - 1] && (r = s[o - 1]), o++, n = s[o], o++; "" !== s[o] && o < s.length; ) n = n + "\n" + s[o], 
            o++;
    ...
    dfxp:{
      parse:function(t) {
        t = e(t).filter("tt");
        var i, n, r = 0, o = t.children("div").eq(0), s = o.find("p"), a = t.find("#" + o.attr("style")), l = {
          text:[],
          times:[]
        };
        if (a.length) {
  ...
  function u(e) {
    for (var t = new RegExp("^" + m + n(x) + "(.*)"), i = localStorage.length - 1; i >= 0; --i) {
      var o = localStorage.key(i);
      o = o && o.match(t), (o = o && o[1]) && o.indexOf(g) < 0 && e(o, r(o));
    }
  }
  function c(e) {
    var t = r(e);
  ...
  var f, p, m = "lscache-", g = "-cacheexpiration", v = 10, y = 6e4, b = Math.floor(864e13 / y), x = "", w = !1;
  return {
    set:function(n, d, f) {
      if (e() && i()) {
        try {
        ...
        try {
          ...
          if (!t(e)) return void h("Could not add item with key '" + n + "'", e);
          var p, m = [];
          u(function(e, t) {
            var i = s(t);
          ...
          try {
            ...
            return void h("Could not add item with key '" + n + "', perhaps it's too big?", e);
          }
        }
        f ? a(r(n), (o() + f).toString(v)) :l(r(n));
      }
    },
    get:function(t) {
      if (!e()) return null;
    ...
    e = function() {
      ...
      function n(t) {
        return function() {
          ...
          t.onload = null, r.innerHTML = t.responseText, i = r.getElementsByTagName("svg")[0], 
      ...
      for (r(), v = document.getElementsByTagName("use"), f = 0; f < v.length; f += 1) {
        try {
          c = v[f].getBoundingClientRect();
        } catch (e) {
          c = !1;
        }
        h = v[f].getAttribute("href") || v[f].getAttributeNS(a, "href") || v[f].getAttribute("xlink:href"), 
        g = h && h.split ? h.split("#") :[ "", "" ], u = g[0], d = g[1], p = c && 0 === c.left && 0 === c.right && 0 === c.top && 0 === c.bottom, 
        c && 0 === c.width && 0 === c.height && !p ? (b && !u.length && d && !document.getElementById(d) && (u = b), 
        v[f].hasAttribute("href") && v[f].setAttributeNS(a, "xlink:href", h), u.length && (y = i[u], 
        !0 !== y && setTimeout(t({
          useEl:v[f],
          base:u,
          hash:d
        }), 0), y === undefined && (m = s(u)) !== undefined && (y = new m(), i[u] = y, y.onload = n(y), 
        y.onerror = l(y), y.ontimeout = l(y), y.open("GET", u), y.send(), x += 1))) :p ? u.length && i[u] && setTimeout(t({
          useEl:v[f],
          base:u,
          hash:d
        }), 0) :i[u] === undefined ? i[u] = !0 :i[u].onload && (i[u].abort(), delete i[u].onload, 
        i[u] = !0);
      }
      v = "", x += 1, e();
    };
  ...
  l.configure = function(e) {
    var t, i;
    for (t in e) (i = e[t]) !== undefined && e.hasOwnProperty(t) && (u[t] = i);
    return this;
  }, l.status = null, l.set = function(t) {
    var n = l.isStarted();
    t = e(t, u.minimum, 1), l.status = 1 === t ? null :t;
    var r = l.render(!n), o = r.querySelector(u.barSelector), s = u.speed, a = u.easing;
    return r.offsetWidth, c(function(e) {
      "" === u.positionUsing && (u.positionUsing = l.getPositioningCSS()), d(o, i(t, s, a)), 
      1 === t ? (d(r, {
        transition:"none",
        opacity:1
    ...
    var n, o = i.querySelector(u.barSelector), s = e ? "-100" :t(l.status || 0), c = document.querySelector(u.parent);
    return d(o, {
      transition:"all 0 linear",
      transform:"translate3d(" + s + "%,0,0)"
    }), u.showSpinner || (n = i.querySelector(u.spinnerSelector)) && a(n), c != document.body && r(c, "nprogress-custom-parent"), 
    c.appendChild(i), i;
  }, l.remove = function() {
  ...
  var t = e.tablesorter = {
    ...
    setup:function(i, n) {
      ...
      n.last = {
        sortList:[],
        clickedIndex:-1
      }, /tablesorter\-/.test(o.attr("class")) || (r = "" !== n.theme ? " tablesorter-" + n.theme :""), 
      n.table = i, n.$table = o.addClass(t.css.table + " " + n.tableClass + r).attr("role", "grid"), 
      n.$headers = o.find(n.selectorHeaders), n.namespace ? n.namespace = "." + n.namespace.replace(t.regex.nonWord, "") :n.namespace = ".tablesorter" + Math.random().toString(16).slice(2), 
      n.$table.children().children("tr").attr("role", "row"), n.$tbodies = o.children("tbody:not(." + n.cssInfoBlock + ")").attr({
        "aria-live":"polite",
        "aria-relevant":"all"
      }), n.$table.children("caption").length && (r = n.$table.children("caption")[0], 
      r.id || (r.id = n.namespace.slice(1) + "caption"), n.$table.attr("aria-labelledby", r.id)), 
      ...
      t.bindEvents(i, n.$headers, !0), t.bindMethods(n), n.supportsDataObject && "undefined" != typeof o.data().sortlist ? n.sortList = o.data().sortlist :s && o.metadata() && o.metadata().sortlist && (n.sortList = o.metadata().sortlist), 
      t.applyWidget(i, !0), n.sortList.length > 0 ? t.sortOn(n, n.sortList, {}, !n.initWidgets) :(t.setHeadersCss(n), 
      n.initWidgets && t.applyWidget(i, !1)), n.showProcessing && o.unbind("sortBegin" + n.namespace + " sortEnd" + n.namespace).bind("sortBegin" + n.namespace + " sortEnd" + n.namespace, function(e) {
      ...
      n.debug && console.groupEnd && console.groupEnd()), o.triggerHandler("tablesorter-initialized", i), 
    ...
    bindMethods:function(i) {
      ...
      n.unbind(o.replace(t.regex.spaces, " ")).bind("sortReset" + r, function(e, i) {
        ...
        i = e.extend(!0, t.defaults, r), i.originalSettings = r, this.hasInitialized = !1, 
        t.setup(this, i);
      });
    },
    bindEvents:function(i, n, r) {
      i = e(i)[0];
      var o, s = i.config, a = s.namespace, l = null;
      !0 !== r && (n.addClass(a.slice(1) + "_extra_headers"), (o = e.fn.closest ? n.closest("table")[0] :n.parents("table")[0]) && "TABLE" === o.nodeName && o !== i && e(o).addClass(a.slice(1) + "_extra_table")), 
      o = (s.pointerDown + " " + s.pointerUp + " " + s.pointerClick + " sort keyup ").replace(t.regex.spaces, " ").split(" ").join(a + " "), 
      n.find(s.selectorSort).add(n.filter(s.selectorSort)).unbind(o).bind(o, function(i, r) {
        var o, a, u, c = e(i.target), d = " " + i.type + " ";
        if (!(1 !== (i.which || i.button) && !d.match(" " + s.pointerClick + " | sort | keyup ") || " keyup " === d && i.which !== t.keyCodes.enter || d.match(" " + s.pointerClick + " ") && "undefined" != typeof i.which || d.match(" " + s.pointerUp + " ") && l !== i.target && !0 !== r)) {
          if (d.match(" " + s.pointerDown + " ")) return l = i.target, u = c.jquery.split("."), 
          void ("1" === u[0] && u[1] < 4 && i.preventDefault());
          if (l = null, t.regex.formElements.test(i.target.nodeName) || c.hasClass(s.cssNoSort) || c.parents("." + s.cssNoSort).length > 0 || c.parents("button").length > 0) return !s.cancelSelection;
          s.delayInit && t.isEmptyObject(s.cache) && t.buildCache(s), o = e.fn.closest ? e(this).closest("th, td") :/TH|TD/.test(this.nodeName) ? e(this) :e(this).parents("th, td"), 
          u = n.index(o), s.last.clickedIndex = u < 0 ? o.attr("data-column") :u, a = s.$headers[s.last.clickedIndex], 
    ...
    buildHeaders:function(i) {
      var n, r, o, s;
      for (i.headerList = [], i.headerContent = [], i.sortVars = [], i.debug && (o = new Date()), 
      ...
      i.$headers = e(e.map(i.$table.find(i.selectorHeaders), function(n, o) {
        var s, a, l, u, c, d = e(n);
        if (!d.parent().hasClass(i.cssIgnoreRow)) return s = t.getColumnData(i.table, i.headers, o, !0), 
        ...
        i.sortVars[l] = {
          ...
          lockedOrder:!1
        }, c = t.getData(d, s, "lockedOrder") || !1, void 0 !== c && !1 !== c && (i.sortVars[l].lockedOrder = !0, 
        i.sortVars[l].order = t.getOrder(c) ? [ 1, 1 ] :[ 0, 0 ]), i.headerList[o] = n, 
        d.addClass(t.css.header + " " + i.cssHeader).parent().addClass(t.css.headerRow + " " + i.cssHeaderRow).attr("role", "row"), 
      ...
      i.$table.find(i.selectorHeaders).attr({
        scope:"col",
        role:"columnheader"
      }), t.updateHeader(i), i.debug && (console.log("Built headers:" + t.benchmark(o)), 
    ...
    setupParsers:function(e, i) {
      var n, r, o, s, a, l, u, c, d, h, f, p, m, g, v = e.table, y = 0, b = {};
      ...
      r = {
        ...
        if (n = m[y].rows, n.length) for (a = 0, s = e.columns, l = 0; l < s; l++) {
    ...
    detectParserForColumn:function(i, n, r, o) {
      for (var s, a, l, u = t.parsers.length, c = !1, d = "", h = !0; "" === d && h; ) r++, 
      l = n[r], l && r < 50 ? l.className.indexOf(t.cssIgnoreRow) < 0 && (c = n[r].cells[o], 
      d = t.getElementText(i, c, o), a = e(c), i.debug && console.log("Checking if value was empty on row " + r + ", column: " + o + ': "' + d + '"')) :h = !1;
    ...
    buildCache:function(i, n, r) {
      var o, s, a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, C, S, k, T, M = i.table, D = i.parsers;
      if (i.$tbodies = i.$table.children("tbody:not(." + i.cssInfoBlock + ")"), d = void 0 === r ? i.$tbodies :r, 
      i.cache = {}, i.totalRows = 0, !D) return i.debug ? console.warn("Warning: *Empty table!* Not building a cache") :"";
      for (i.debug && (g = new Date()), i.showProcessing && t.isProcessing(M, !0), c = 0; c < d.length; c++) {
        for (x = [], o = i.cache[c] = {
          normalized:[]
        }, v = d[c] && d[c].rows.length || 0, l = 0; l < v; ++l) if (y = {
          child:[],
          raw:[]
        }, h = e(d[c].rows[l]), f = [], !h.hasClass(i.selectorRemove.slice(1))) if (h.hasClass(i.cssChildRow) && 0 !== l) for (k = o.normalized.length - 1, 
        b = o.normalized[k][i.columns], b.$row = b.$row.add(h), h.prev().hasClass(i.cssChildRow) || h.prev().addClass(t.css.cssHasChild), 
        p = h.children("th, td"), k = b.child.length, b.child[k] = [], _ = 0, S = i.columns, 
        u = 0; u < S; u++) m = p[u], m && (b.child[k][u] = t.getParsedText(i, m, u), (w = p[u].colSpan - 1) > 0 && (_ += w, 
        S += w)), _++; else {
          for (y.$row = h, y.order = l, _ = 0, S = i.columns, u = 0; u < S; ++u) {
            if ((m = h[0].cells[u]) && _ < i.columns && (C = "undefined" != typeof D[_], !C && i.debug && console.warn("No parser found for row: " + l + ", column: " + u + '; cell containing: "' + e(m).text() + '"; does it have a header?'), 
    ...
    getColumnText:function(i, n, r, o) {
      ...
      if (!t.isEmptyObject(b)) {
        for (c = b.$tbodies.length, s = 0; s < c; s++) for (l = b.cache[s].normalized, d = l.length, 
    ...
    setHeadersCss:function(i) {
      var n, r, o, s = i.sortList, a = s.length, l = t.css.sortNone + " " + i.cssNone, u = [ t.css.sortAsc + " " + i.cssAsc, t.css.sortDesc + " " + i.cssDesc ], c = [ i.cssIconAsc, i.cssIconDesc, i.cssIconNone ], d = [ "ascending", "descending" ], h = i.$table.find("tfoot tr").children("td, th").add(e(i.namespace + "_extra_headers")).removeClass(u.join(" "));
      for (i.$headers.add(e("thead " + i.namespace + "_extra_headers")).removeClass(u.join(" ")).addClass(l).attr("aria-sort", "none").find("." + t.css.icon).removeClass(c.join(" ")).addClass(c[2]), 
      r = 0; r < a; r++) if (2 !== s[r][1] && (n = i.$headers.filter(function(e) {
        for (var n = !0, r = i.$headers.eq(e), o = parseInt(r.attr("data-column"), 10), s = o + i.$headers[e].colSpan; o < s; o++) n = !!n && (n || t.isValueInArray(o, i.sortList) > -1);
        return n;
      }), n = n.not(".sorter-false").filter('[data-column="' + s[r][0] + '"]' + (1 === a ? ":last" :"")), 
      n.length)) {
        for (o = 0; o < n.length; o++) n[o].sortDisabled || n.eq(o).removeClass(l).addClass(u[s[r][1]]).attr("aria-sort", d[s[r][1]]).find("." + t.css.icon).removeClass(c[2]).addClass(c[s[r][1]]);
        h.length && h.filter('[data-column="' + s[r][0] + '"]').removeClass(l).addClass(u[s[r][1]]);
      }
      for (a = i.$headers.length, r = 0; r < a; r++) t.setColumnAriaLabel(i, i.$headers.eq(r));
    },
    ...
    updateHeaderSortCount:function(i, n) {
      ...
      for (i.sortList = [], a = 0; a < f; a++) if (c = h[a], (r = parseInt(c[0], 10)) < i.columns) {
        ...
        i.sortVars[r].order = d, i.sortVars[r].count = 0), d = i.sortVars[r].order, o = ("" + c[1]).match(/^(1|d|s|o|n)/), 
        o = o ? o[0] :"") {
         case "1":
         case "d":
          o = 1;
         ...
         case "o":
          u = d[(l || 0) % d.length], o = 0 === u ? 1 :1 === u ? 0 :2;
          break;
    ...
    updateCell:function(i, n, r, o) {
      ...
      var s, a, l, u, c, d, h = i.$tbodies, f = e(n), p = h.index(e.fn.closest ? f.closest("tbody") :f.parents("tbody").filter(":first")), m = i.cache[p], g = e.fn.closest ? f.closest("tr") :f.parents("tr").filter(":first");
      if (n = f[0], h.length && p >= 0) {
        if (l = h.eq(p).find("tr").index(g), c = m.normalized[l], (d = g[0].cells.length) !== i.columns) for (u = 0, 
        s = !1, a = 0; a < d; a++) s || g[0].cells[a] === n ? s = !0 :u += g[0].cells[a].colSpan; else u = f.index();
        s = t.getElementText(i, n, u), c[i.columns].raw[u] = s, s = t.getParsedText(i, n, u, s), 
        c[u] = s, c[i.columns].$row = g, "numeric" === (i.parsers[u].type || "").toLowerCase() && (m.colMax[u] = Math.max(Math.abs(s) || 0, m.colMax[u] || 0)), 
        s = "undefined" !== r ? r :i.resort, !1 !== s ? t.checkResort(i, s, o) :t.resortComplete(i, o);
    ...
    appendCache:function(e, i) {
      var n, r, o, s, a, l, u, c = e.table, d = e.widgetOptions, h = e.$tbodies, f = [], p = e.cache;
      if (t.isEmptyObject(p)) return e.appender ? e.appender(c, f) :c.isUpdating ? e.$table.triggerHandler("updateComplete", c) :"";
      for (e.debug && (u = new Date()), l = 0; l < h.length; l++) if (o = h.eq(l), o.length) {
        for (s = t.processTbody(c, o, !0), n = p[l].normalized, r = n.length, a = 0; a < r; a++) f[f.length] = n[a][e.columns].$row, 
        e.appender && (!e.pager || e.pager.removeRows && d.pager_removeRows || e.pager.ajax) || s.append(n[a][e.columns].$row);
        t.processTbody(c, s, !1);
      }
      e.appender && e.appender(c, f), e.debug && console.log("Rebuilt table" + t.benchmark(u)), 
    ...
    initSort:function(i, n, r) {
      ...
      var o, s, a, l, u, c, d, h = !r[i.sortMultiSortKey], f = i.table, p = i.$headers.length, m = parseInt(e(n).attr("data-column"), 10), g = i.sortVars[m].order;
      if (i.$table.triggerHandler("sortStart", f), c = (i.sortVars[m].count + 1) % g.length, 
      i.sortVars[m].count = r[i.sortResetKey] ? 2 :c, i.sortRestart) for (a = 0; a < p; a++) d = i.$headers.eq(a), 
      c = parseInt(d.attr("data-column"), 10), m !== c && (h || d.hasClass(t.css.sortNone)) && (i.sortVars[c].count = -1);
      if (h) {
        if (i.sortList = [], i.last.sortList = [], null !== i.sortForce) for (o = i.sortForce, 
        s = 0; s < o.length; s++) o[s][0] !== m && (i.sortList[i.sortList.length] = o[s]);
        if ((l = g[i.sortVars[m].count]) < 2 && (i.sortList[i.sortList.length] = [ m, l ], 
        n.colSpan > 1)) for (s = 1; s < n.colSpan; s++) i.sortList[i.sortList.length] = [ m + s, l ], 
        i.sortVars[m + s].count = e.inArray(l, g);
      } else if (i.sortList = e.extend([], i.last.sortList), t.isValueInArray(m, i.sortList) >= 0) for (s = 0; s < i.sortList.length; s++) c = i.sortList[s], 
      c[0] === m && (c[1] = g[i.sortVars[m].count], 2 === c[1] && (i.sortList.splice(s, 1), 
      ...
      !t.isEmptyObject(o))) for (s = 0; s < o.length; s++) if (o[s][0] !== m && t.isValueInArray(o[s][0], i.sortList) < 0) {
        if (l = o[s][1], u = ("" + l).match(/^(a|d|s|o|n)/)) switch (c = i.sortList[0][1], 
        u[0]) {
         case "d":
          l = 1;
          break;
        ...
        i.sortList[i.sortList.length] = [ o[s][0], l ];
      }
    ...
    multisort:function(e) {
      var i, n, r, o, s, a = e.table, l = [], u = 0, c = e.textSorter || "", d = e.sortList, h = d.length, f = e.$tbodies.length;
      if (!e.serverSideSorting && !t.isEmptyObject(e.cache)) {
        if (e.debug && (n = new Date()), "object" == typeof c) for (r = e.columns; r--; ) "function" == typeof (s = t.getColumnData(a, c, r)) && (l[r] = s);
        for (i = 0; i < f; i++) r = e.cache[i].colMax, o = e.cache[i].normalized, o.sort(function(i, n) {
          var o, s, f, p, m, g, v;
          for (o = 0; o < h; o++) {
            if (f = d[o][0], p = d[o][1], u = 0 === p, e.sortStable && i[f] === n[f] && 1 === h) return i[e.columns].order - n[e.columns].order;
            if (s = /n/i.test(t.getSortType(e.parsers, f)), s && e.strings[f] ? (s = "boolean" == typeof t.string[e.strings[f]] ? (u ? 1 :-1) * (t.string[e.strings[f]] ? -1 :1) :e.strings[f] ? t.string[e.strings[f]] || 0 :0, 
            m = e.numberSorter ? e.numberSorter(i[f], n[f], u, r[f], a) :t["sortNumeric" + (u ? "Asc" :"Desc")](i[f], n[f], s, r[f], f, e)) :(g = u ? i :n, 
            v = u ? n :i, m = "function" == typeof c ? c(g[f], v[f], u, f, a) :"function" == typeof l[f] ? l[f](g[f], v[f], u, f, a) :t["sortNatural" + (u ? "Asc" :"Desc")](i[f], n[f], f, e)), 
            m) return m;
          }
          return i[e.columns].order - n[e.columns].order;
        });
        e.debug && console.log("Applying sort " + d.toString() + t.benchmark(n));
      }
    },
    ...
    sortOn:function(i, n, r, o) {
      var s = i.table;
      i.$table.triggerHandler("sortStart", s), t.updateHeaderSortCount(i, n), t.setHeadersCss(i), 
      i.delayInit && t.isEmptyObject(i.cache) && t.buildCache(i), i.$table.triggerHandler("sortBegin", s), 
      t.multisort(i), t.appendCache(i, o), i.$table.triggerHandler("sortBeforeEnd", s), 
      i.$table.triggerHandler("sortEnd", s), t.applyWidget(s), e.isFunction(r) && r(s);
    },
    ...
    sortNatural:function(e, i) {
      ...
      if (u.hex.test(i)) {
        if (n = parseInt((e || "").match(u.hex), 16), r = parseInt((i || "").match(u.hex), 16), 
        n < r) return -1;
        if (n > r) return 1;
      }
      for (n = (e || "").replace(u.chunk, "\\0$1\\0").replace(u.chunks, "").split("\\0"), 
      r = (i || "").replace(u.chunk, "\\0$1\\0").replace(u.chunks, "").split("\\0"), l = Math.max(n.length, r.length), 
      a = 0; a < l; a++) {
    ...
    applyWidgetOptions:function(i) {
      var n, r, o = i.config, s = o.widgets.length;
      if (s) for (n = 0; n < s; n++) (r = t.getWidgetById(o.widgets[n])) && r.options && (o.widgetOptions = e.extend(!0, {}, r.options, o.widgetOptions), 
      e.extend(!0, t.defaults.widgetOptions, r.options));
    },
    ...
    applyWidgetId:function(i, n, r) {
      i = e(i)[0];
      var o, s, a, l = i.config, u = l.widgetOptions, c = t.getWidgetById(n);
      c && (a = c.id, o = !1, e.inArray(a, l.widgets) < 0 && (l.widgets[l.widgets.length] = a), 
      l.debug && (s = new Date()), !r && l.widgetInit[a] || (l.widgetInit[a] = !0, i.hasInitialized && t.applyWidgetOptions(i), 
      "function" == typeof c.init && (o = !0, l.debug && console[console.group ? "group" :"log"]("Initializing " + a + " widget"), 
      c.init(i, c, l, u))), r || "function" != typeof c.format || (o = !0, l.debug && console[console.group ? "group" :"log"]("Updating " + a + " widget"), 
      c.format(i, l, u, !1)), l.debug && o && (console.log("Completed " + (r ? "initializing " :"applying ") + a + " widget" + t.benchmark(s)), 
      console.groupEnd && console.groupEnd()));
    },
    applyWidget:function(i, n, r) {
      i = e(i)[0];
      var o, s, a, l, u, c = i.config, d = [];
      if (!1 === n || !i.hasInitialized || !i.isApplyingWidgets && !i.isUpdating) {
        if (c.debug && (u = new Date()), t.addWidgetFromClass(i), clearTimeout(c.timerReady), 
        c.widgets.length) {
          for (i.isApplyingWidgets = !0, c.widgets = e.grep(c.widgets, function(t, i) {
            return e.inArray(t, c.widgets) === i;
          }), a = c.widgets || [], s = a.length, o = 0; o < s; o++) l = t.getWidgetById(a[o]), 
          l && l.id ? (l.priority || (l.priority = 10), d[o] = l) :c.debug && console.warn('"' + a[o] + '" widget code does not exist!');
          for (d.sort(function(e, t) {
            return e.priority < t.priority ? -1 :e.priority === t.priority ? 0 :1;
          }), s = d.length, c.debug && console[console.group ? "group" :"log"]("Start " + (n ? "initializing" :"applying") + " widgets"), 
          o = 0; o < s; o++) (l = d[o]) && l.id && t.applyWidgetId(i, l.id, n);
          c.debug && console.groupEnd && console.groupEnd(), n || "function" != typeof r || r(i);
        }
        c.timerReady = setTimeout(function() {
          i.isApplyingWidgets = !1, e.data(i, "lastWidgetApplication", new Date()), c.$table.triggerHandler("tablesorter-ready");
        }, 10), c.debug && (l = c.widgets.length, console.log("Completed " + (!0 === n ? "initializing " :"applying ") + l + " widget" + (1 !== l ? "s" :"") + t.benchmark(u)));
      }
    },
    removeWidget:function(i, n, r) {
      i = e(i)[0];
      var o, s, a, l, u = i.config;
      ...
      for (l = n.length, o = 0; o < l; o++) s = t.getWidgetById(n[o]), a = e.inArray(n[o], u.widgets), 
      a >= 0 && !0 !== r && u.widgets.splice(a, 1), s && s.remove && (u.debug && console.log((r ? "Refreshing" :"Removing") + ' "' + n[o] + '" widget'), 
      s.remove(i, u, u.widgetOptions, r), u.widgetInit[n[o]] = !1);
    },
    refreshWidgets:function(i, n, r) {
      i = e(i)[0];
      var o, s, a = i.config, l = a.widgets, u = t.widgets, c = u.length, d = [], h = function(t) {
        e(t).triggerHandler("refreshComplete");
      };
      for (o = 0; o < c; o++) (s = u[o]) && s.id && (n || e.inArray(s.id, l) < 0) && (d[d.length] = s.id);
      t.removeWidget(i, d.join(","), !0), !0 !== r ? (t.applyWidget(i, n || !1, h), n && t.applyWidget(i, !1, h)) :h(i);
    },
    ...
    computeColumnIndex:function(t, i) {
      var n, r, o, s, a, l, u, c, d, h, f = i && i.columns || 0, p = [], m = new Array(f);
      for (n = 0; n < t.length; n++) for (l = t[n].cells, r = 0; r < l.length; r++) {
        for (a = l[r], u = a.parentNode.rowIndex, c = a.rowSpan || 1, d = a.colSpan || 1, 
        "undefined" == typeof p[u] && (p[u] = []), o = 0; o < p[u].length + 1; o++) if ("undefined" == typeof p[u][o]) {
          h = o;
          break;
        }
        for (f && a.cellIndex === h || (a.setAttribute ? a.setAttribute("data-column", h) :e(a).attr("data-column", h)), 
        o = u; o < u + c; o++) for ("undefined" == typeof p[o] && (p[o] = []), m = p[o], 
        s = h; s < h + d; s++) m[s] = "x";
      }
      return m.length;
    },
    fixColumnWidth:function(i) {
      i = e(i)[0];
      var n, r, o, s, a, l = i.config, u = l.$table.children("colgroup");
      if (u.length && u.hasClass(t.css.colgroup) && u.remove(), l.widthFixed && 0 === l.$table.children("colgroup").length) {
        for (u = e('<colgroup class="' + t.css.colgroup + '">'), n = l.$table.width(), o = l.$tbodies.find("tr:first").children(":visible"), 
        s = o.length, a = 0; a < s; a++) r = parseInt(o.eq(a).width() / n * 1e3, 10) / 10 + "%", 
        u.append(e("<col>").css("width", r));
        l.$table.prepend(u);
      }
    },
    ...
    getColumnData:function(t, i, n, r, o) {
      ...
      t = e(t)[0];
      var s, a, l = t.config, u = o || l.$headers, c = l.$headerIndexed && l.$headerIndexed[n] || u.filter('[data-column="' + n + '"]:last');
      if ("undefined" != typeof i[n]) return r ? i[n] :i[u.index(c)];
      for (a in i) if ("string" == typeof a && (s = c.filter(a).add(c.find(a)), s.length)) return i[a];
    },
    isProcessing:function(i, n, r) {
      i = e(i);
      var o = i[0].config, s = r || i.find("." + t.css.header);
    ...
    replaceAccents:function(e) {
      ...
      if (!t.characterRegex) {
        ...
        for (i in r) "string" == typeof i && (n += r[i], t.characterRegexArray[i] = new RegExp("[" + r[i] + "]", "g"));
    ...
    validateOptions:function(i) {
      ...
      if (l) {
        i.debug && (s = new Date());
        for (n in l) if ("undefined" === (o = typeof t.defaults[n])) console.warn('Tablesorter Warning! "table.config.' + n + '" option not recognized'); else if ("object" === o) for (r in l[n]) o = t.defaults[n] && typeof t.defaults[n][r], 
        e.inArray(n, a) < 0 && "undefined" === o && console.warn('Tablesorter Warning! "table.config.' + n + "." + r + '" option not recognized');
        i.debug && console.log("validate options time:" + t.benchmark(s));
      }
    },
    restoreHeaders:function(i) {
      var n, r, o = e(i)[0].config, s = o.$table.find(o.selectorHeaders), a = s.length;
      for (n = 0; n < a; n++) r = s.eq(n), r.find("." + t.css.headerIn).length && r.html(o.headerContent[n]);
    },
    destroy:function(i, n, r) {
      if (i = e(i)[0], i.hasInitialized) {
        t.removeWidget(i, !0, !1);
        var o, s = e(i), a = i.config, l = a.debug, u = s.find("thead:first"), c = u.find("tr." + t.css.headerRow).removeClass(t.css.headerRow + " " + a.cssHeaderRow), d = s.find("tfoot:first > tr").children("th, td");
        !1 === n && e.inArray("uitheme", a.widgets) >= 0 && (s.triggerHandler("applyWidgetId", [ "uitheme" ]), 
        s.triggerHandler("applyWidgetId", [ "zebra" ])), u.find("tr").not(c).remove(), o = "sortReset update updateRows updateAll updateHeaders updateCell addRows updateComplete sorton appendCache updateCache applyWidgetId applyWidgets refreshWidgets removeWidget destroy mouseup mouseleave " + "keypress sortBegin sortEnd resetToLoadState ".split(" ").join(a.namespace + " "), 
        s.removeData("tablesorter").unbind(o.replace(t.regex.spaces, " ")), a.$headers.add(d).removeClass([ t.css.header, a.cssHeader, a.cssAsc, a.cssDesc, t.css.sortAsc, t.css.sortDesc, t.css.sortNone ].join(" ")).removeAttr("data-column").removeAttr("aria-label").attr("aria-disabled", "true"), 
        c.find(a.selectorSort).unbind("mousedown mouseup keypress ".split(" ").join(a.namespace + " ").replace(t.regex.spaces, " ")), 
        t.restoreHeaders(i), s.toggleClass(t.css.table + " " + a.tableClass + " tablesorter-" + a.theme, !1 === n), 
        i.hasInitialized = !1, delete i.config.cache, "function" == typeof r && r(i), l && console.log("tablesorter has been removed");
      }
    }
  };
  ...
  t.addParser({
    ...
    format:function(e) {
      var i, n = (e || "").match(t.regex.timeMatch), r = new Date(e), o = e && (null !== n ? n[0] :"00:00 AM"), s = o ? new Date("2000/01/01 " + o.replace(t.regex.dateReplace, "$1 $2")) :o;
      return s instanceof Date && isFinite(s) ? (i = r instanceof Date && isFinite(r) ? r.getTime() :0, 
      i ? parseFloat(s.getTime() + "." + r.getTime()) :s.getTime()) :e;
    },
    type:"numeric"
  }), t.addParser({
    id:"metadata",
    ...
    format:function(t, i, n) {
      ...
      for (l = 0; l < h.length; l++) for (s = 0, r = h.eq(l).children("tr:visible").not(i.selectorRemove), 
      c = r.length, u = 0; u < c; u++) o = r.eq(u), d.test(o[0].className) || s++, a = s % 2 == 0, 
      o.removeClass(n.zebra[a ? 1 :0]).addClass(n.zebra[a ? 0 :1]);
    },
    remove:function(e, i, n, r) {
      if (!r) {
        var o, s, a = i.$tbodies, l = (n.zebra || [ "even", "odd" ]).join(" ");
        for (o = 0; o < a.length; o++) s = t.processTbody(e, a.eq(o), !0), s.children().removeClass(l), 
  ...
  return function(e, t, i) {
    ...
    n.storage = function(r, o, s, a) {
      r = e(r)[0];
      var l, u, c, d = !1, h = {}, f = r.config, p = f && f.widgetOptions, m = a && a.useSessionStorage || p && p.storage_useSessionStorage ? "sessionStorage" :"localStorage", g = e(r), v = a && a.id || g.attr(a && a.group || p && p.storage_group || "data-table-group") || p && p.storage_tableId || r.id || e(".tablesorter").index(g), y = a && a.url || g.attr(a && a.page || p && p.storage_page || "data-table-page") || p && p.storage_fixedUrl || f && f.fixedUrl || t.location.pathname;
      if (e.extend(!0, n.defaults, {
        ...
        t[m].setItem("_tmptest", "temp"), d = !0, t[m].removeItem("_tmptest");
      } catch (e) {
        f && f.debug && console.warn(m + " is not supported in this browser");
      }
      if (e.parseJSON && (d ? h = e.parseJSON(t[m][o] || "null") || {} :(u = i.cookie.split(/[;\s|=]/), 
      l = e.inArray(o, u) + 1, h = 0 !== l ? e.parseJSON(u[l] || "null") || {} :{})), 
      void 0 === s || !t.JSON || !JSON.hasOwnProperty("stringify")) return h && h[y] ? h[y][v] :"";
      h[y] || (h[y] = {}), h[y][v] = s, d ? t[m][o] = JSON.stringify(h) :(c = new Date(), 
      c.setTime(c.getTime() + 31536e6), i.cookie = o + "=" + JSON.stringify(h).replace(/\"/g, '"') + "; expires=" + c.toGMTString() + "; path=/");
    };
    ...
    t.themes = {
      ...
      format:function(i, n, r) {
        var o, s, a, l, u, c, d, h, f, p, m, g, v, y = t.themes, b = n.$table.add(e(n.namespace + "_extra_table")), x = n.$headers.add(e(n.namespace + "_extra_headers")), w = n.theme || "jui", _ = y[w] || {}, C = e.trim([ _.sortNone, _.sortDesc, _.sortAsc, _.active ].join(" ")), S = e.trim([ _.iconSortNone, _.iconSortDesc, _.iconSortAsc ].join(" "));
        for (n.debug && (u = new Date()), b.hasClass("tablesorter-" + w) && n.theme === n.appliedTheme && r.uitheme_applied || (r.uitheme_applied = !0, 
        ...
        d = t.css.icon ? c.find("." + t.css.icon) :e(), f = x.not(".sorter-false").filter('[data-column="' + o + '"]:last'), 
        f.length && (c.removeClass(C), d.removeClass(S), f[0].sortDisabled ? d.removeClass(_.icons || "") :(a = _.sortNone, 
        ...
        n.debug && console.log("Applying " + w + " theme" + t.benchmark(u));
      },
      remove:function(e, i, n, r) {
    ...
    t.addWidget({
      ...
      format:function(i, n, r) {
        ...
        for (d = v.join(" "), s = 0; s < p.length; s++) o = t.processTbody(i, p.eq(s), !0), 
        a = o.children("tr"), a.each(function() {
      ...
      remove:function(i, n, r) {
        ...
        o = 0; o < a.length; o++) s = t.processTbody(i, a.eq(o), !0), s.children("tr").each(function() {
    ...
    e.extend(r, {
      ...
      remove:function(t, i, o, s) {
        var a, l, u = i.$table, c = i.$tbodies, d = "addRows updateCell update updateRows updateComplete appendCache filterReset filterEnd search ".split(" ").join(i.namespace + "filter ");
        if (u.removeClass("hasFilters").unbind(d.replace(n.regex.spaces, " ")).find("." + r.filterRow).remove(), 
        o.filter_initialized = !1, !s) {
          for (a = 0; a < c.length; a++) l = n.processTbody(t, c.eq(a), !0), l.children().removeClass(o.filter_filteredRow).show(), 
      ...
      types:{
        or:function(n, r, o) {
          if ((i.orTest.test(r.iFilter) || i.orSplit.test(r.filter)) && !i.regex.test(r.filter)) {
            var s, a, l, u, c = e.extend({}, r), d = r.filter.split(i.orSplit), h = r.iFilter.split(i.orSplit), f = d.length;
            for (s = 0; s < f; s++) {
              c.nestedFilters = !0, c.filter = "" + (t.parseFilter(n, d[s], r) || ""), c.iFilter = "" + (t.parseFilter(n, h[s], r) || ""), 
              l = "(" + (t.parseFilter(n, c.filter, r) || "") + ")";
              try {
                if (u = new RegExp(r.isMatch ? l :"^" + l + "$", n.widgetOptions.filter_ignoreCase ? "i" :""), 
                a = u.test(c.exact) || t.processTypes(n, c, o)) return a;
              } catch (e) {
                return null;
              }
            }
        ...
        and:function(n, r, o) {
          if (i.andTest.test(r.filter)) {
            var s, a, l, u, c, d = e.extend({}, r), h = r.filter.split(i.andSplit), f = r.iFilter.split(i.andSplit), p = h.length;
            for (s = 0; s < p; s++) {
              d.nestedFilters = !0, d.filter = "" + (t.parseFilter(n, h[s], r) || ""), d.iFilter = "" + (t.parseFilter(n, f[s], r) || ""), 
              u = ("(" + (t.parseFilter(n, d.filter, r) || "") + ")").replace(i.wild01, "\\S{1}").replace(i.wild0More, "\\S*");
              try {
                c = new RegExp(r.isMatch ? u :"^" + u + "$", n.widgetOptions.filter_ignoreCase ? "i" :""), 
                l = c.test(d.exact) || t.processTypes(n, d, o), a = 0 === s ? l :a && l;
              } catch (e) {
                return null;
              }
            }
        ...
        operators:function(r, o) {
          if (i.operTest.test(o.iFilter) && "" !== o.iExact) {
            ...
            a = t.parseFilter(r, l, o, !0), d = "number" != typeof a || "" === a || isNaN(a) ? d :a), 
        ...
        range:function(e, r) {
          if (i.toTest.test(r.iFilter)) {
            ...
            (d || "numeric" === e.parsers[c].type) && (o = e.parsers[c].format("" + h[0], u, e.$headers.eq(c), c), 
            a = "" === o || isNaN(o) ? a :o, o = e.parsers[c].format("" + h[1], u, e.$headers.eq(c), c), 
            l = "" === o || isNaN(o) ? l :o), !d && "numeric" !== e.parsers[c].type || isNaN(a) || isNaN(l) ? (s = isNaN(r.iExact) ? r.iExact.replace(n.regex.nondigit, "") :r.iExact, 
      ...
      init:function(o) {
        ...
        var s, a, l, u, c, d, h, f, p = o.config, m = p.widgetOptions;
        ...
        p.$table.bind(l, function(i, s) {
          ...
          t.buildDefault(o, !0)), "filterReset" === i.type ? (p.$table.find("." + r.filter).add(m.filter_$externalFilters).val(""), 
          ...
          p.$table.triggerHandler("filterReset");
        })), m.filter_functions) for (c = 0; c < p.columns; c++) if (h = n.getColumnData(o, m.filter_functions, c)) if (u = p.$headerIndexed[c].removeClass("filter-select"), 
        f = !(u.hasClass("filter-false") || u.hasClass("parser-false")), s = "", !0 === h && f) t.buildSelect(o, c); else if ("object" == typeof h && f) {
          ...
          d = a, l = a, a.indexOf(m.filter_selectSourceSeparator) >= 0 && (d = a.split(m.filter_selectSourceSeparator), 
          l = d[1], d = d[0]), s += "<option " + (l === d ? "" :'data-function-name="' + a + '" ') + 'value="' + d + '">' + l + "</option>");
          p.$table.find("thead").find("select." + r.filter + '[data-column="' + c + '"]').append(s), 
          l = m.filter_selectSource, h = "function" == typeof l || n.getColumnData(o, l, c), 
          h && t.buildSelect(p.table, c, "", !0, u.hasClass(m.filter_onlyAvail));
        }
      ...
      filterInitComplete:function(i) {
        var n, r, o = i.widgetOptions, s = 0, a = function() {
          o.filter_initialized = !0, i.lastSearch = i.$table.data("lastSearch"), i.$table.triggerHandler("filterInit", i), 
          t.findRows(i.table, i.lastSearch || []);
        };
        if (e.isEmptyObject(o.filter_formatter)) a(); else {
          for (r = o.filter_formatterInit.length, n = 0; n < r; n++) 1 === o.filter_formatterInit[n] && s++;
          clearTimeout(o.filter_initTimer), o.filter_initialized || s !== o.filter_formatterCount ? o.filter_initialized || (o.filter_initTimer = setTimeout(function() {
            a();
          }, 500)) :a();
        }
      },
      ...
      buildRow:function(i, o, s) {
        var a, l, u, c, d, h, f, p, m, g = s.filter_cellFilter, v = o.columns, y = e.isArray(g), b = '<tr role="row" class="' + r.filterRow + " " + o.cssIgnoreRow + '">';
        for (u = 0; u < v; u++) o.$headerIndexed[u].length && (m = o.$headerIndexed[u] && o.$headerIndexed[u][0].colSpan || 0, 
        b += m > 1 ? '<td data-column="' + u + "-" + (u + m - 1) + '" colspan="' + m + '"' :'<td data-column="' + u + '"', 
        ...
        d ? b = e("<select>").appendTo(a) :(p = n.getColumnData(i, s.filter_formatter, u), 
        p ? (s.filter_formatterCount++, b = p(a, u), b && 0 === b.length && (b = a.children("input")), 
        ...
        b.addClass(r.filter + " " + f).attr("data-column", a.attr("data-column")), h && (b.attr("placeholder", "").addClass(r.filterDisabled)[0].disabled = !0)));
      },
      bindSearch:function(i, r, s) {
        if (i = e(i)[0], r = e(r), r.length) {
          ...
          r.attr("data-lastSearchTime", new Date().getTime()).unbind(a.replace(n.regex.spaces, " ")).bind("keydown" + c, function(e) {
            ...
            t.searching(i, !0, !0, s);
          }).bind("search change keypress input ".split(" ").join(c + " "), function(r) {
            var s = parseInt(e(this).attr("data-column"), 10), a = "boolean" == typeof u.filter_liveSearch ? u.filter_liveSearch :n.getColumnData(i, u.filter_liveSearch, s);
            !i.config.widgetOptions.filter_initialized || r.which !== o.enter && "search" !== r.type && ("change" !== r.type && "input" !== r.type || !0 !== a || this.value === l.lastSearch[s]) || (r.preventDefault(), 
            e(this).attr("data-lastSearchTime", new Date().getTime()), t.searching(i, "keypress" !== r.type, !0, s));
          });
        }
      },
      ...
      checkFilters:function(i, o, s) {
        var a = i.config, l = a.widgetOptions, u = e.isArray(o), c = u ? o :n.getFilters(i, !0), d = (c || []).join("");
        ...
        if (u && (n.setFilters(i, c, !1, !0 !== s), l.filter_initialized || (a.lastCombinedFilter = "")), 
        l.filter_hideFilters && a.$table.find("." + r.filterRow).triggerHandler(t.hideFiltersCheck(a) ? "mouseleave" :"mouseenter"), 
        a.lastCombinedFilter !== d || !1 === o) {
          if (!1 === o && (a.lastCombinedFilter = null, a.lastSearch = []), c = c || [], c = Array.prototype.map ? c.map(String) :c.join("\ufffd").split("\ufffd"), 
      ...
      findRange:function(e, t, i) {
        ...
        if (!i && /-/.test(t)) for (r = t.match(/(\d+)\s*-\s*(\d+)/g), d = r ? r.length :0, 
        c = 0; c < d; c++) {
          for (o = r[c].split(/\s*-\s*/), s = parseInt(o[0], 10) || 0, a = parseInt(o[1], 10) || e.columns - 1, 
          s > a && (n = s, s = a, a = n), a >= e.columns && (a = e.columns - 1); s <= a; s++) h[h.length] = s;
          t = t.replace(r[c], "");
        }
        if (!i && /,/.test(t)) for (l = t.split(/\s*,\s*/), d = l.length, u = 0; u < d; u++) "" !== l[u] && (c = parseInt(l[u], 10)) < e.columns && (h[h.length] = c);
      ...
      processTypes:function(i, n, r) {
        var o, s = null, a = null;
        for (o in t.types) e.inArray(o, r.excludeMatch) < 0 && null === a && null !== (a = t.types[o](i, n, r)) && (s = a);
        return s;
      },
      ...
      processRow:function(r, o, s) {
        ...
        if (o.$cells = o.$row.children(), o.anyMatchFlag && m.length > 1 || o.anyMatchFilter && !p) {
        ...
        o.iFilter = h.filter_ignoreCase ? (o.filter || "").toLowerCase() :o.filter, u = s.functions[m], 
        l = null, u && (!0 === u ? l = o.isMatch ? ("" + o.iExact).search(o.iFilter) >= 0 :o.filter === o.exact :"function" == typeof u ? l = u(o.exact, o.cache, o.filter, m, o.$row, r, o) :"function" == typeof u[c || o.filter] && (d = c || o.filter, 
        l = u[d](o.exact, o.cache, o.filter, m, o.$row, r, o))), null === l ? (l = t.processTypes(r, o, s), 
        null !== l ? a = l :(d = (o.iExact + o.childRowText).indexOf(t.parseFilter(r, o.iFilter, o)), 
        a = !h.filter_startsWith && d >= 0 || h.filter_startsWith && 0 === d)) :a = l, f = !!a && f);
        return f;
      },
      findRows:function(r, o, s) {
        if (r.config.lastCombinedFilter !== s && r.config.widgetOptions.filter_initialized) {
          var a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, C, S, k, T, M, D, A, P = e.extend([], o), I = r.config, j = I.widgetOptions, E = {
            anyMatch:!1,
            filters:o,
            filter_regexCache:[]
          }, F = {
          ...
          for (E.parsed = [], m = 0; m < I.columns; m++) E.parsed[m] = j.filter_useParsedData || I.parsers && I.parsers[m] && I.parsers[m].parsed || n.getData && "parsed" === n.getData(I.$headerIndexed[m], n.getColumnData(r, I.headers, m), "filter") || I.$headerIndexed[m].hasClass("filter-parsed"), 
          F.functions[m] = n.getColumnData(r, j.filter_functions, m) || I.$headerIndexed[m].hasClass("filter-select"), 
          F.defaultColFilter[m] = n.getColumnData(r, j.filter_defaultFilter, m) || "", F.excludeFilter[m] = (n.getColumnData(r, j.filter_excludeFilter, m, !0) || "").split(/\s+/);
          for (I.debug && (console.log("Filter: Starting filter widget search", o), x = new Date()), 
          I.filteredRows = 0, I.totalRows = 0, s = (P || []).join(""), f = 0; f < I.$tbodies.length; f++) {
            if (p = n.processTbody(r, I.$tbodies.eq(f), !0), m = I.columns, l = I.cache[f].normalized, 
            c = e(e.map(l, function(e) {
              return e[m].$row.get();
            })), "" === s || j.filter_serversideFiltering) c.removeClass(j.filter_filteredRow).not("." + I.cssChildRow).css("display", ""); else {
              if (c = c.not("." + I.cssChildRow), a = c.length, (j.filter_$anyMatch && j.filter_$anyMatch.length || "undefined" != typeof o[I.columns]) && (E.anyMatchFlag = !0, 
              E.anyMatchFilter = "" + (o[I.columns] || j.filter_$anyMatch && t.getLatestSearch(j.filter_$anyMatch).val() || ""), 
              j.filter_columnAnyMatch)) {
                for (k = E.anyMatchFilter.split(i.andSplit), T = !1, _ = 0; _ < k.length; _++) M = k[_].split(":"), 
                M.length > 1 && (isNaN(M[0]) ? e.each(I.headerContent, function(e, t) {
                  t.toLowerCase().indexOf(M[0]) > -1 && (D = e, o[D] = M[1]);
                }) :D = parseInt(M[0], 10) - 1, D >= 0 && D < I.columns && (o[D] = M[1], k.splice(_, 1), 
                _--, T = !0));
                T && (E.anyMatchFilter = k.join(" && "));
              }
              ...
              for (C = c.not("." + j.filter_filteredRow).length, S && 0 === C && (S = !1), I.debug && console.log("Filter: Searching through " + (S && C < a ? C :"all") + " rows"), 
              E.anyMatchFlag && (I.sortLocaleCompare && (E.anyMatchFilter = n.replaceAccents(E.anyMatchFilter)), 
              j.filter_defaultFilter && i.iQuery.test(F.defaultAnyFilter) && (E.anyMatchFilter = t.defaultFilter(E.anyMatchFilter, F.defaultAnyFilter), 
              S = !1), E.iAnyMatchFilter = j.filter_ignoreCase && I.ignoreCase ? E.anyMatchFilter.toLowerCase() :E.anyMatchFilter), 
              h = 0; h < a; h++) if (A = c[h].className, !(h && i.child.test(A) || S && i.filtered.test(A))) {
                if (E.$row = c.eq(h), E.rowIndex = h, E.cacheArray = l[h], u = E.cacheArray[I.columns], 
                E.rawArray = u.raw, E.childRowText = "", !j.filter_childByColumn) {
                  for (A = "", g = u.child, _ = 0; _ < g.length; _++) A += " " + g[_].join(" ") || "";
                  E.childRowText = j.filter_childRows ? j.filter_ignoreCase ? A.toLowerCase() :A :"";
                }
                if (y = !1, b = t.processRow(I, E, F), d = u.$row, w = !!b, g = u.$row.filter(":gt(0)"), 
                j.filter_childRows && g.length) {
                  if (j.filter_childByColumn) for (j.filter_childWithSibs || (g.addClass(j.filter_filteredRow), 
                  d = d.eq(0)), _ = 0; _ < g.length; _++) E.$row = g.eq(_), E.cacheArray = u.child[_], 
                  E.rawArray = E.cacheArray, w = t.processRow(I, E, F), y = y || w, !j.filter_childWithSibs && w && g.eq(_).removeClass(j.filter_filteredRow);
                  y = y || b;
                } else y = w;
          ...
          I.lastCombinedFilter = s, I.lastSearch = P, I.$table.data("lastSearch", P), j.filter_saveFilters && n.storage && n.storage(r, "tablesorter-filters", t.processFilters(P, !0)), 
          I.debug && console.log("Completed filter widget search" + n.benchmark(x)), j.filter_initialized && (I.$table.triggerHandler("filterBeforeEnd", I), 
      ...
      getOptionSource:function(i, r, o) {
        i = e(i)[0];
        var s = i.config, a = s.widgetOptions, l = !1, u = a.filter_selectSource, c = s.$table.data("lastSearch") || [], d = "function" == typeof u || n.getColumnData(i, u, r);
        if (o && "" !== c[r] && (o = !1), !0 === d) l = u(i, r, o); else {
          if (d instanceof e || "string" === e.type(d) && d.indexOf("</option>") >= 0) return d;
          e.isArray(d) ? l = d :"object" === e.type(u) && d && (l = d(i, r, o));
        }
        return !1 === l && (l = t.getOptions(i, r, o)), t.processOptions(i, r, l);
      },
      processOptions:function(t, i, r) {
        if (!e.isArray(r)) return !1;
        t = e(t)[0];
        var o, s, a, l, u, c, d = t.config, h = void 0 !== i && null !== i && i >= 0 && i < d.columns, f = !!h && d.$headerIndexed[i].hasClass("filter-select-sort-desc"), p = [];
        if (r = e.grep(r, function(t, i) {
          return !!t.text || e.inArray(t, r) === i;
        }), h && d.$headerIndexed[i].hasClass("filter-select-nosort")) return r;
        for (l = r.length, a = 0; a < l; a++) s = r[a], c = s.text ? s.text :s, u = (h && d.parsers && d.parsers.length && d.parsers[i].format(c, t, [], i) || c).toString(), 
      ...
      getOptions:function(t, i, r) {
        t = e(t)[0];
        var o, s, a, l, u, c, d, h, f = t.config, p = f.widgetOptions, m = [];
      ...
      buildSelect:function(n, o, s, a, l) {
        if (n = e(n)[0], o = parseInt(o, 10), n.config.cache && !e.isEmptyObject(n.config.cache)) {
          ...
          if (void 0 !== s && "" !== s || (s = t.getOptionSource(n, o, l)), e.isArray(s)) {
            for (u = 0; u < s.length; u++) if (m = s[u], m.text) {
              m["data-function-name"] = "undefined" == typeof m.value ? m.text :m.value, b += "<option";
              for (c in m) m.hasOwnProperty(c) && "text" !== c && (b += " " + c + '="' + m[c] + '"');
              m.value || (b += ' value="' + m.text + '"'), b += ">" + m.text + "</option>";
            } else "" + m != "[object Object]" && (d = m = ("" + m).replace(i.quote, "&quot;"), 
            c = d, d.indexOf(v.filter_selectSourceSeparator) >= 0 && (h = d.split(v.filter_selectSourceSeparator), 
            c = h[0], d = h[1]), b += "" !== m ? "<option " + (c === d ? "" :'data-function-name="' + m + '" ') + 'value="' + c + '">' + d + "</option>" :"");
            s = [];
          }
          ...
          p = f.filter('select[data-column="' + o + '"]'), p.length && (p[a ? "html" :"append"](b), 
          e.isArray(s) || p.append(s).val(x), p.val(x));
        }
      },
      buildDefault:function(e, i) {
        var r, o, s, a = e.config, l = a.widgetOptions, u = a.columns;
        for (r = 0; r < u; r++) o = a.$headerIndexed[r], s = !(o.hasClass("filter-false") || o.hasClass("parser-false")), 
      ...
      if (!0 !== n && f && !f.filter_columnFilters || e.isArray(o) && o.join("") === h.lastCombinedFilter) return e(i).data("lastSearch");
      ...
      u = l.filter(c), u.length && (u = t.getLatestSearch(u), e.isArray(o) ? (s && u.length > 1 && (u = u.slice(1)), 
      a === h.columns && (c = u.filter(f.filter_anyColumnSelector), u = c.length ? c :u), 
    ...
    e.extend(i.css, {
      ...
      if (t = e(t)[0], t.config) {
        var r = {
          ...
          for (a.resize_flag = !0, i = [], t = 0; t < u; t++) n = s.$headers.eq(t), r = n.data("savedSizes") || [ 0, 0 ], 
      ...
      format:function(n, r, o) {
        if (!(r.$table.hasClass("hasStickyHeaders") || e.inArray("filter", r.widgets) >= 0 && !r.$table.hasClass("hasFilters"))) {
          var s, a, l, u, c = r.$table, d = e(o.stickyHeaders_attachTo), h = r.namespace + "stickyheaders ", f = e(o.stickyHeaders_yScroll || o.stickyHeaders_attachTo || t), p = e(o.stickyHeaders_xScroll || o.stickyHeaders_attachTo || t), m = c.children("thead:first"), g = m.children("tr").not(".sticky-false").children(), v = c.children("tfoot"), y = isNaN(o.stickyHeaders_offset) ? e(o.stickyHeaders_offset) :"", b = y.length ? y.height() || 0 :parseInt(o.stickyHeaders_offset, 10) || 0, x = c.parent().closest("." + i.css.table).hasClass("hasStickyHeaders") ? c.parent().closest("table.tablesorter")[0].config.widgetOptions.$sticky.parent() :[], w = x.length ? x.height() :0, _ = o.$sticky = c.clone().addClass("containsStickyHeaders " + i.css.sticky + " " + o.stickyHeaders + " " + r.namespace.slice(1) + "_extra_table").wrap('<div class="' + i.css.stickyWrap + '">'), C = _.parent().addClass(i.css.stickyHide).css({
            position:d.length ? "absolute" :"fixed",
            padding:parseInt(_.parent().parent().css("padding-left"), 10),
            top:b + w,
            left:0,
            visibility:"hidden",
            zIndex:o.stickyHeaders_zIndex || 2
          }), S = _.children("thead:first"), k = "", T = 0, M = function(e, i) {
            var n, r, o, s, a, l = e.filter(":visible"), u = l.length;
            for (n = 0; n < u; n++) s = i.filter(":visible").eq(n), a = l.eq(n), "border-box" === a.css("box-sizing") ? r = a.outerWidth() :"collapse" === s.css("border-collapse") ? t.getComputedStyle ? r = parseFloat(t.getComputedStyle(a[0], null).width) :(o = parseFloat(a.css("border-width")), 
            ...
            b = y.length ? y.height() || 0 :parseInt(o.stickyHeaders_offset, 10) || 0, T = 0, 
            C.css({
              left:d.length ? parseInt(d.css("padding-left"), 10) || 0 :c.offset().left - parseInt(c.css("margin-left"), 10) - p.scrollLeft() - T,
              width:c.outerWidth()
            }), M(c, _), M(g, u);
          }, A = function(t) {
            if (c.is(":visible")) {
              w = x.length ? x.offset().top - f.scrollTop() + x.height() :0;
              var n = c.offset(), r = e.isWindow(f[0]), s = e.isWindow(p[0]), a = d.length ? r ? f.scrollTop() :f.offset().top :f.scrollTop(), l = o.stickyHeaders_includeCaption ? 0 :c.children("caption").height() || 0, u = a + b + w - l, h = c.height() - (C.height() + (v.height() || 0)) - l, m = u > n.top && u < n.top + h ? "visible" :"hidden", g = {
                visibility:m
              };
              d.length && (g.top = r ? u - d.offset().top :d.scrollTop()), s && (g.left = c.offset().left - parseInt(c.css("margin-left"), 10) - p.scrollLeft() - T), 
              x.length && (g.top = (g.top || 0) + b + w), C.removeClass(i.css.stickyVis + " " + i.css.stickyHide).addClass("visible" === m ? i.css.stickyVis :i.css.stickyHide).css(g), 
              (m !== k || t) && (D(), k = m);
            }
          };
          if (d.length && !d.css("position") && d.css("position", "relative"), _.attr("id") && (_[0].id += o.stickyHeaders_cloneId), 
          _.find("thead:gt(0), tr.sticky-false").hide(), _.find("tbody, tfoot").remove(), 
          _.find("caption").toggle(o.stickyHeaders_includeCaption), u = S.children().children(), 
          _.css({
            height:0,
            width:0,
            margin:0
          }), u.find("." + i.css.resizer).remove(), c.addClass("hasStickyHeaders").bind("pagerComplete" + h, function() {
            D();
          }), i.bindEvents(n, S.children().children("." + i.css.header)), o.stickyHeaders_appendTo ? e(o.stickyHeaders_appendTo).append(C) :c.after(C), 
          r.onRenderHeader) for (l = S.children("tr").children(), a = l.length, s = 0; s < a; s++) r.onRenderHeader.apply(l.eq(s), [ s, r, _ ]);
          p.add(f).unbind("scroll resize ".split(" ").join(h).replace(/\s+/g, " ")).bind("scroll resize ".split(" ").join(h), function(e) {
            A("resize" === e.type);
          }), r.$table.unbind("stickyHeadersUpdate" + h).bind("stickyHeadersUpdate" + h, function() {
            A(!0);
          }), o.stickyHeaders_addResizeEvent && i.addHeaderResizeEvent(n), c.hasClass("hasFilters") && o.filter_columnFilters && (c.bind("filterEnd" + h, function() {
            var n = e(document.activeElement).closest("td"), s = n.parent().children().index(n);
            C.hasClass(i.css.stickyVis) && o.stickyHeaders_filteredToTop && (t.scrollTo(0, c.position().top), 
            s >= 0 && r.$filters && r.$filters.eq(s).find("a, select, input").filter(":visible").focus());
          }), i.filter.bindSearch(c, u.find("." + i.css.filter)), o.filter_hideFilters && i.filter.hideFilters(r, _)), 
          o.stickyHeaders_addResizeEvent && c.bind("resize" + r.namespace + "stickyheaders", function() {
            D();
          }), c.triggerHandler("stickyHeadersInit");
        }
      },
      remove:function(n, r, o) {
        var s = r.namespace + "stickyheaders ";
        r.$table.removeClass("hasStickyHeaders").unbind("pagerComplete resize filterEnd stickyHeadersUpdate ".split(" ").join(s).replace(/\s+/g, " ")).next("." + i.css.stickyWrap).remove(), 
    ...
    e.extend(i.css, {
      ...
      setWidths:function(t, n, r) {
        ...
        if (r = r || a.storedSizes || [], r.length) {
          ...
          s = e(t.namespace + "_extra_table"), s.length && !i.hasWidget(t.table, "scroller") && i.resizable.setWidth(s, t.$table.outerWidth(), a.overflow);
        }
      },
      setHandlePosition:function(t, n) {
        ...
        })), r = t.$table.position().left, s.each(function() {
          var i = e(this), s = parseInt(i.attr("data-column"), 10), l = t.columns - 1, u = i.data("header");
          u && (u.is(":visible") ? (s < l || s === l && n.resizable_addLastColumn) && i.css({
            display:"inline-block",
            height:o,
            left:u.position().left - r + u.outerWidth() - a
          }) :i.hide());
        });
      },
      ...
      bindings:function(n, r) {
        ...
        r.$resizable_container.children().bind("mousedown", function(t) {
          ...
          i.resizable.setHandlePosition(n, r);
        }), n.$table.bind("columnUpdate" + o + " pagerComplete" + o, function() {
          i.resizable.setHandlePosition(n, r);
      ...
      e(t).each(function() {
        ...
        if (t && o && o.$headerIndexed.length) {
          ...
          a.useStorage && i.storage(t, "tablesorter-table-resized-width", "auto")), e = 0; e < o.columns; e++) r = o.$headerIndexed[e], 
          s.resizable_widths && s.resizable_widths[e] ? i.resizable.setWidth(r, s.resizable_widths[e], a.overflow) :r.hasClass("resizable-false") || i.resizable.setWidth(r, "", a.overflow);
    ...
    t.addWidget({
      ...
      format:function(i, n, r, o) {
        var s, a, l = n.$table, u = !1 !== r.saveSort, c = {
          sortList:n.sortList
        };
        n.debug && (a = new Date()), l.hasClass("hasSaveSort") ? u && i.hasInitialized && t.storage && (t.storage(i, "tablesorter-savesort", c), 
        n.debug && console.log("saveSort widget: Saving last sort: " + n.sortList + t.benchmark(a))) :(l.addClass("hasSaveSort"), 
        c = "", t.storage && (s = t.storage(i, "tablesorter-savesort"), c = s && s.hasOwnProperty("sortList") && e.isArray(s.sortList) ? s.sortList :"", 
        n.debug && console.log('saveSort: Last sort loaded: "' + c + '"' + t.benchmark(a)), 
        l.bind("saveSortReset", function(e) {
          e.stopPropagation(), t.storage(i, "tablesorter-savesort", "");
        })), o && c && c.length > 0 ? n.sortList = c :i.hasInitialized && c && c.length > 0 && t.sortOn(n, c));
      },
      remove:function(e, i) {
  ...
  (function() {
    (function() {
      ...
      this.LocalTime = {
        ...
        process:function() {
          var t, i, n, r;
          for (i = 1 <= arguments.length ? e.call(arguments, 0) :[], n = 0, r = i.length; n < r; n++) t = i[n], 
  ...
  (function() {
    (function() {
      ...
      n = !isNaN(Date.parse("2011-01-01T12:00:00-05:00")), t.parseDate = function(e) {
        ...
        l = r[6], c = r[7], "Z" !== c && (a = c.replace(":", "")), u + "/" + s + "/" + i + " " + n + ":" + o + ":" + l + " GMT" + [ a ];
      };
    }.call(this), function() {
      ...
      e = t.config, n = e.i18n, t.getI18nValue = function(r, o) {
        ...
        return null == r && (r = ""), s = (null != o ? o :{
          locale:e.locale
        }).locale, a = i(n[s], r), null != a ? a :s !== e.defaultLocale ? t.getI18nValue(r, {
          locale:e.defaultLocale
        }) :void 0;
      }, t.translate = function(e, i, n) {
        var r, o, s;
        null == i && (i = {}), s = t.getI18nValue(e, n);
        for (r in i) o = i[r], s = s.replace("{" + r + "}", o);
        return s;
      }, i = function(e, t) {
        var i, n, r, o, s;
        for (s = e, o = t.split("."), i = 0, r = o.length; i < r; i++) {
          if (n = o[i], null == s[n]) return null;
          s = s[n];
        }
        return s;
      };
      ...
      e = t.getI18nValue, o = t.translate, t.strftime = r = function(t, s) {
        ...
        var t, i, n, r, o;
        return o = e.toString(), (t = null != (i = o.match(/\(([\w\s]+)\)$/)) ? i[1] :void 0) ? /\s/.test(t) ? t.match(/\b(\w)/g).join("") :t :(t = null != (n = o.match(/(\w{3,4})\s\d{4}$/)) ? n[1] :void 0) ? t :(t = null != (r = o.match(/(UTC[\+\-]\d+)/)) ? r[1] :void 0) ? t :"";
      };
    }.call(this), function() {
      ...
      e = t.elementMatchesSelector, t.PageObserver = function() {
        ...
        return t.prototype.start = function() {
          ...
          for (t = [], i = 0, r = e.length; i < r; i++) switch (s = e[i], s.type) {
           case "childList":
            for (l = s.addedNodes, n = 0, o = l.length; n < o; n++) a = l[n], t.push.apply(t, this.findSignificantElements(a));
          }
      ...
      n = t.parseDate, r = t.strftime, i = t.getI18nValue, e = t.config, t.Controller = function() {
        ...
        return a = "time[data-local]:not([data-localized])", s.prototype.start = function() {
          ...
          var t, o, s, a, c;
          if (t = e.getAttribute("datetime"), o = e.getAttribute("data-format"), s = e.getAttribute("data-local"), 
          a = n(t), !isNaN(a)) return e.hasAttribute("title") || (c = r(a, i("datetime.formats.default")), 
          e.setAttribute("title", c)), e.textContent = function() {
            switch (s) {
             case "time":
              return l(e), r(a, o);

             case "date":
              return l(e), u(a).toDateString();

             case "time-ago":
              return u(a).toString();

             case "time-or-date":
              return u(a).toTimeOrDateString();

             case "weekday":
              return u(a).toWeekdayString();

             case "weekday-or-date":
              return u(a).toWeekdayString() || u(a).toDateString();
            }
          }();
        }, l = function(e) {
...
//# sourceMappingURL=/assets/maps/application_vendor-d691c8f1e9a4ba2c0a0f66fe84cea4bba1d96fcd52829b2efaadb647d54c30c1.js.map
