(function() {
  ...
  code:function(t, e, i) {
    ...
    r.s(r.f("response", t, e, 1), t, e, 0, 214, 267, "{{ }}") && (r.rs(t, e, function(t, e, r) {
      r.b("        <strong>Unfortunately, "), r.b(r.t(r.f("response", t, e, 0))), r.b("\n" + i);
    ...
    r.b(r.t(r.f("icon_right_arrow", t, e, 0))), r.b("</button>"), r.b("\n" + i)), r.s(r.f("final_exam", t, e, 1), t, e, 1, 0, 0, "") || r.s(r.f("finished", t, e, 1), t, e, 0, 1268, 1352, "{{ }}") && (r.rs(t, e, function(t, e, r) {
  ...
  Treehouse.Quiz = function(i) {
    function s() {
      this.generateFeedback = t(this.generateFeedback, this), this.render = t(this.render, this), 
      this.finishQuiz = t(this.finishQuiz, this), this.processError = t(this.processError, this), 
      this.addhighlightingForFITB = t(this.addhighlightingForFITB, this), this.processResponse = t(this.processResponse, this), 
    ...
    return e(s, i), s.prototype.submit = function(t, e) {
      ...
      var t, e, i;
      if (i = this.feedbackEl, this.quizData.fill_in_the_blank) return this.quizData.feedback && (t = function() {
        var t, i, r, s;
        for (r = this.quizData.feedback, s = [], t = 0, i = r.length; t < i; t++) e = r[t], 
        s.push(e.answer);
        return s;
      }.call(this)), $(".text-fill-in-blank").each(function() {
        var e, s;
        return e = $(this), !e.text() || t && (s = $(this).text().toLowerCase().trim(), 
        r.call(t, s) >= 0) ? e.addClass("fitb-incorrect").prepend(i.data("icon-close")) :e.addClass("fitb-correct").prepend(i.data("icon-checkmark"));
      });
      ...
      var e, i, r;
      return r = "", t.fill_in_the_blank && null !== t.feedback ? (i = t.feedback.map(function(t) {
        return t.feedback;
      ...
      return this.addhighlightingForFITB(), this.quizData.answer_passed ? this.renderFeedback("success") :this.renderFeedback("error"), 
  ...
  Featurette.register("countdown-timer", function(i) {
    function r() {
      this.updateTimer = t(this.updateTimer, this), this.getTimeLeft = t(this.getTimeLeft, this), 
      r.__super__.constructor.apply(this, arguments), this.endTime = this.data.endTime, 
      this.timerId = this.data.timerId, this.timeoutText = this.data.timeoutText, this.timer = $("#" + this.timerId), 
      this.updateTimer(), setInterval(this.updateTimer, 1e3);
    }
    return e(r, i), r.prototype.getTimeLeft = function() {
      var t, e, i, r;
      return r = Date.parse(this.endTime) - Date.parse(new Date()), i = Math.floor(r / 1e3 % 60).toString(), 
      e = Math.floor(r / 1e3 / 60 % 60).toString(), t = Math.floor(r / 36e5 % 24).toString().padStart(2, "0"), 
      Math.floor(r / 864e5).toString().padStart(2, "0"), {
        total:r,
        minutes:e,
        seconds:i,
        hours:t
      ...
      var t;
      return t = this.getTimeLeft(), t.minutes < 5 && this.timer.parent().addClass("short-time-left"), 
      (t.minutes < 0 || t.hours <= 0) && (this.timer.parent().removeClass("under-10sec"), 
      this.timer.parent().removeClass("under-1min"), this.timer.parent().addClass("timeout"), 
      this.timer.parent().html(this.timeoutText)), t.seconds < 20 && t.minutes < 1 && (this.timer.parent().removeClass("under-2min"), 
      this.timer.parent().removeClass("under-1min"), this.timer.parent().removeClass("under-10sec"), 
      this.timer.parent().addClass("under-20sec")), t.seconds < 10 && t.minutes < 1 && (this.timer.parent().removeClass("under-2min"), 
      this.timer.parent().removeClass("under-1min"), this.timer.parent().removeClass("under-20sec"), 
      this.timer.parent().addClass("under-10sec")), t.minutes < 1 ? (this.timer.html(t.seconds + " seconds"), 
      this.timer.parent().removeClass("under-2min"), this.timer.parent().addClass("under-1min")) :t.minutes < 2 ? (this.timer.html(t.minutes + ":" + t.seconds.padStart(2, "0")), 
      this.timer.parent().removeClass("under-1min"), this.timer.parent().addClass("under-2min")) :this.timer.html(t.minutes + " minutes");
    }, r;
  }(Treehouse.View));
}.call(this), function() {
  var t, e = function(t, e) {
  ...
  t = function(t) {
    ...
    return i(r, t), r.prototype.openAlert = function(t, e) {
      var i;
      if (this.el.find("[data-message]").text(t), i = this.el.find(".alert-banner"), i.removeClass("info success warning error"), 
      i.addClass(e || "info"), this.el.removeClass("hidden-alert"), this.timeout && clearTimeout(this.timeout), 
      "success" === e) return this.timeout = setTimeout(function(t) {
        return function() {
          return t.closeAlert();
        };
      }(this), 3e3);
  ...
  t = function(t) {
    function r() {
      ...
      this.submitInviteForm = e(this.submitInviteForm, this), this.togglePanelVisibility = e(this.togglePanelVisibility, this), 
      r.__super__.constructor.apply(this, arguments), this.on("click", ".add-member", this.togglePanelVisibility), 
      this.on("click", "[data-invite-button]", this.submitInviteForm), this.on("click", "[data-reinvite-button]", this.resendInvite), 
    ...
    return i(r, t), r.prototype.togglePanelVisibility = function(t) {
      ...
      var e, i;
      return t.preventDefault(), e = $(t.currentTarget), i = e.closest("form"), $.ajax({
        url:i.attr("action"),
        type:i.attr("method"),
        data:i.serialize(),
        beforeSend:function(t) {
        ...
        success:function(t) {
          return function(e) {
            return $("#invitations").html(e), t.get("[data-email]").val(""), Featurette.get("talentpath-alert").openAlert("Invitation sent!", "success");
          };
        }(this),
        error:function(t) {
          return function(e) {
      ...
      var e, i;
      return t.preventDefault(), e = $(t.currentTarget), i = e.attr("data-reinvite-path"), 
      $.ajax({
        url:i,
        type:"post",
        beforeSend:function() {
        ...
        success:function() {
          ...
          e.closest("tr").find("[data-invited-date]").text(new Date().toString("M/dd/yyyy"));
        },
        complete:function() {
  ...
  t = function(t) {
    ...
    return i(r, t), r.prototype.toggleDetails = function(t) {
      ...
      var t, e, i;
      return t = this.get("[data-toggle-details-action-text]"), i = t.text(), e = t.attr("data-toggle-details-action-text"), 
  ...
  Featurette.register("open-new-tab", Treehouse.OpenNewTab = function(e) {
    function i() {
      i.__super__.constructor.apply(this, arguments), this.el.find("[data-open-new-tab] a").attr("target", "_blank");
    }
    return t(i, e), i;
  }(Treehouse.View));
}.call(this), function() {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
  ...
  _gsScope._gsDefine("TweenMax", [ "core.Animation", "core.SimpleTimeline", "TweenLite" ], function(t, e, i) {
    ...
    var u, c, p, d, f, g, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g, y = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, _ = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, v = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, b = /(?:\d|\-|\+|=|#|\.)*/g, w = /opacity *= *([^)]*)/i, T = /opacity:([^;]*)/i, k = /alpha\(opacity *=.+?\)/i, C = /^(rgb|hsl)/, x = /([A-Z])/g, S = /-([a-z])/gi, P = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, $ = function(t, e) {
    ...
    }, D = /(?:Left|Right|Width)/i, F = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, A = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, O = /,(?=[^\)]*(?:\(|$))/gi, E = Math.PI / 180, z = 180 / Math.PI, R = {}, B = document, I = function(t) {
      return B.createElementNS ? B.createElementNS("http://www.w3.org/1999/xhtml", t) :B.createElement(t);
    }, M = I("div"), V = I("img"), j = o._internals = {
      _specialProps:l
    }, L = navigator.userAgent, q = function() {
      var t = L.indexOf("Android"), e = I("a");
      ...
      return q || (n.opacity = N(t)), r = It(t, e, !1), n.rotation = r.rotation, n.skewX = r.skewX, 
    ...
    var Tt, kt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Ct = Q("transform"), xt = H + "transform", St = Q("transformOrigin"), Pt = null !== Q("perspective"), $t = j.Transform = function() {
    ...
    }, It = j.getTransform = function(t, i, r, n) {
      ...
      Tt = o.useSVGTransformAttr || Ot), (a = Bt(t)) !== Rt) {
        if (16 === a.length) {
          var v, b, w, T, k, C = a[0], x = a[1], S = a[2], P = a[3], $ = a[4], D = a[5], F = a[6], A = a[7], O = a[8], E = a[9], R = a[10], B = a[12], I = a[13], M = a[14], V = a[11], j = Math.atan2(F, R);
          d.zOrigin && (M = -d.zOrigin, B = O * M - a[12], I = E * M - a[13], M = R * M + d.zOrigin - a[14]), 
          d.rotationX = j * z, j && (T = Math.cos(-j), k = Math.sin(-j), v = $ * T + O * k, 
          b = D * T + E * k, w = F * T + R * k, O = $ * -k + O * T, E = D * -k + E * T, R = F * -k + R * T, 
          V = A * -k + V * T, $ = v, D = b, F = w), j = Math.atan2(-S, R), d.rotationY = j * z, 
          j && (T = Math.cos(-j), k = Math.sin(-j), v = C * T - O * k, b = x * T - E * k, 
          w = S * T - R * k, E = x * k + E * T, R = S * k + R * T, V = P * k + V * T, C = v, 
          ...
          d.skewX = 0, d.perspective = V ? 1 / (0 > V ? -V :V) :0, d.x = B, d.y = I, d.z = M, 
    ...
    }, Vt = j.set3DTransformRatio = j.setTransformRatio = function(t) {
      var e, i, r, s, n, o, a, l, h, u, c, p, f, g, m, y, _, v, b, w, T, k, C, x = this.data, S = this.t.style, P = x.rotation, $ = x.rotationX, D = x.rotationY, F = x.scaleX, A = x.scaleY, O = x.scaleZ, z = x.x, R = x.y, B = x.z, I = x.svg, M = x.perspective, V = x.force3D;
      if (((1 === t || 0 === t) && "auto" === V && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !V) && !B && !M && !D && !$ && 1 === O || Tt && I || !Pt) return void (P || x.skewX || I ? (P *= E, 
      ...
      i *= _, n *= _, x.skewY && (e *= _, s *= _)), I && (z += x.xOrigin - (x.xOrigin * e + x.yOrigin * i) + x.xOffset, 
      ...
      I && Tt ? this.t.setAttribute("transform", "matrix(" + b) :S[Ct] = (x.xPercent || x.yPercent ? "translate(" + x.xPercent + "%," + x.yPercent + "%) matrix(" :"matrix(") + b) :S[Ct] = (x.xPercent || x.yPercent ? "translate(" + x.xPercent + "%," + x.yPercent + "%) matrix(" :"matrix(") + F + ",0,0," + A + "," + z + "," + R + ")");
      ...
      m *= _, y *= _, x.skewY && (e *= _, s *= _))), i = -y, n = m; else {
        if (!(D || $ || 1 !== O || M || I)) return void (S[Ct] = (x.xPercent || x.yPercent ? "translate(" + x.xPercent + "%," + x.yPercent + "%) translate3d(" :"translate3d(") + z + "px," + R + "px," + B + "px)" + (1 !== F || 1 !== A ? " scale(" + F + "," + A + ")" :""));
        e = n = 1, i = s = 0;
      }
      ...
      a *= F, u *= F), (f || I) && (f && (z += r * -f, R += o * -f, B += h * -f + f), 
      I && (z += x.xOrigin - (x.xOrigin * e + x.yOrigin * i) + x.xOffset, R += x.yOrigin - (x.xOrigin * s + x.yOrigin * n) + x.yOffset), 
    ...
    h.scaleX = h.scaleY = h.scaleZ = 1, bt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
      parser:function(t, e, i, r, n, a, l) {
        ...
        if (l.display ? (p = K(t, "display"), b.display = "block", h = It(t, s, !0, l.parseTransform), 
        b.display = p) :h = It(t, s, !0, l.parseTransform), r._transform = h, "string" == typeof k.transform && Ct) p = M.style, 
        p[Ct] = k.transform, p.display = "block", p.position = "absolute", B.body.appendChild(M), 
        u = It(M, null, !1), B.body.removeChild(M), u.perspective || (u.perspective = h.perspective), 
      ...
      parser:function(t, e, i, r, n, o) {
        ...
        if (-1 !== m.indexOf("%") != (-1 !== y.indexOf("%")) && (p = K(t, "backgroundImage").replace(P, "")) && "none" !== p) {
          for (a = m.split(" "), l = y.split(" "), V.setAttribute("src", p), h = 2; --h > -1; ) m = a[h], 
          (u = -1 !== m.indexOf("%")) !== (-1 !== l[h].indexOf("%")) && (c = 0 === h ? t.offsetWidth - V.width :t.offsetHeight - V.height, 
    ...
    h = o.prototype, h._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a) {
      ...
      this._transformType) {
        ...
        b.data = this._transform || It(t, s, !0), b.tween = a, b.pr = -1, n.pop();
      }
      if (i) {
        for (;d; ) {
  ...
  if (!i.TweenLite) {
    ...
    var z = [], R = {}, B = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, I = function(t) {
      ...
      return d += e.substr(p), d && c.push(d), c.setRatio = I, c;
      ...
      lazyTweens:z,
      blobDif:M
    }, L = A._plugins = {}, q = j.tweenLookup = {}, N = 0, W = j.reservedProps = {
      ease:1,
      delay:1,
      overwrite:1,
      onComplete:1,
      ...
      "true":1,
      "false":0
    }, U = $._rootFramesTimeline = new F(), Q = $._rootTimeline = new F(), X = 30, K = j.lazyRender = function() {
      var t, e = z.length;
    ...
    n.setRatio = I, n._kill = function(t) {
...
//# sourceMappingURL=/assets/maps/application-7cb1433089397ffbe842a3183e11e74b1c8b456a3fd45cac1742b773294d724c.js.map
